...
} const sCursorOptions[] =
{
    ...
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_FLASH]       = {gMoveNames_Compiled[MOVE_FLASH],       CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_CUT]         = {gMoveNames_Compiled[MOVE_CUT],         CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_FLY]         = {gMoveNames_Compiled[MOVE_FLY],         CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_STRENGTH]    = {gMoveNames_Compiled[MOVE_STRENGTH],    CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_SURF]        = {gMoveNames_Compiled[MOVE_SURF],        CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_ROCK_SMASH]  = {gMoveNames_Compiled[MOVE_ROCK_SMASH],  CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_WATERFALL]   = {gMoveNames_Compiled[MOVE_WATERFALL],   CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_TELEPORT]    = {gMoveNames_Compiled[MOVE_TELEPORT],    CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_DIG]         = {gMoveNames_Compiled[MOVE_DIG],         CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_MILK_DRINK]  = {gMoveNames_Compiled[MOVE_MILK_DRINK],  CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_SOFT_BOILED] = {gMoveNames_Compiled[MOVE_SOFT_BOILED], CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_SWEET_SCENT] = {gMoveNames_Compiled[MOVE_SWEET_SCENT], CursorCB_FieldMove},
};
