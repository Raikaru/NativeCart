...
_CORE_SOURCE_ENTRIES: Sequence[_CoreEntry] = (
    ...
    ("firered_portable", "firered_portable_rom_auto_prepare.c"),
    ...
    ("firered_portable", "firered_portable_rom_species_names_pack.c"),
    ("firered_portable", "firered_portable_rom_mon_pic_layout.c"),
    ("firered_portable", "firered_portable_rom_facility_class_lookups.c"),
    ...
    ("firered_portable", "firered_portable_rom_trainer_money_table.c"),
    ...
    ("firered_portable", "firered_portable_rom_map_connections.c"),
    ("firered_portable", "firered_portable_rom_map_scripts_directory.c"),
    ("firered_portable", "firered_portable_rom_map_events_directory.c"),
    ...
    ("firered_portable", "firered_portable_early_new_game_help_text_rom.c"),
    ("firered_portable", "firered_portable_new_game_intro_prose_rom.c"),
    ...
    ("firered_portable", "region_map_mapsec_names_compiled_export.c"),
