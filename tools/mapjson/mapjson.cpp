...
string generate_map_header_text(Json map_data, Json layouts_data) {
    ...
    string region_map_section = json_to_string(map_data, "region_map_section");
    if (region_map_section == "MAPSEC_SPECIAL_AREA")
        region_map_section = "196";
