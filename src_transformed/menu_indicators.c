...
#ifdef PORTABLE
#include "menu_indicators_portable_assets.h"
#define sRedArrowPal sRedArrowPal_Portable
#define sRedArrowOtherGfx sRedArrowOtherGfx_Portable
#define sSelectorOutlineGfx sSelectorOutlineGfx_Portable
#define sRedArrowGfx sRedArrowGfx_Portable
#endif
...
#ifndef PORTABLE
#define sRedArrowPal ((const u16 *)NULL)
#define sRedArrowOtherGfx ((const u32 *)NULL)
#define sSelectorOutlineGfx ((const u32 *)NULL)
#define sRedArrowGfx ((const u32 *)NULL)
#endif
