...
// Unused
#ifdef PORTABLE
#define sNewGameOakObject_Gfx sNewGameOakObject_Gfx_Portable
#define sNewGameOakObject_Pal sNewGameOakObject_Pal_Portable
#define sPokeballGlow_Gfx sPokeballGlow_Gfx_Portable
#define sPokeballGlow_Pal sPokeballGlow_Pal_Portable
#define sPokecenterMonitor_Gfx sPokecenterMonitor_Gfx_Portable
#define sHofMonitor_Pal sHofMonitor_Pal_Portable
#define sHofMonitor_Gfx sHofMonitor_Gfx_Portable
#define sFieldMoveStreaksOutdoors_Gfx sFieldMoveStreaksOutdoors_Gfx_Portable
#define sFieldMoveStreaksOutdoors_Pal sFieldMoveStreaksOutdoors_Pal_Portable
#define sFieldMoveStreaksOutdoors_Tilemap sFieldMoveStreaksOutdoors_Tilemap_Portable
#define sFieldMoveStreaksIndoors_Gfx sFieldMoveStreaksIndoors_Gfx_Portable
#define sFieldMoveStreaksIndoors_Pal sFieldMoveStreaksIndoors_Pal_Portable
#define sFieldMoveStreaksIndoors_Tilemap sFieldMoveStreaksIndoors_Tilemap_Portable
#define sRockFragment_TopLeft sRockFragment_TopLeft_Portable
#define sRockFragment_TopRight sRockFragment_TopRight_Portable
#define sRockFragment_BottomLeft sRockFragment_BottomLeft_Portable
#define sRockFragment_BottomRight sRockFragment_BottomRight_Portable
#else
#define sNewGameOakObject_Gfx ((const u16 *)NULL)
#define sNewGameOakObject_Pal ((const u16 *)NULL)
#define sPokeballGlow_Gfx ((const u16 *)NULL)
#define sPokeballGlow_Pal ((const u16 *)NULL)
#define sPokecenterMonitor_Gfx ((const u16 *)NULL)
#define sHofMonitor_Pal ((const u16 *)NULL)
#define sHofMonitor_Gfx ((const u16 *)NULL)
#define sFieldMoveStreaksOutdoors_Gfx ((const u16 *)NULL)
#define sFieldMoveStreaksOutdoors_Pal ((const u16 *)NULL)
#define sFieldMoveStreaksOutdoors_Tilemap ((const u16 *)NULL)
#define sFieldMoveStreaksIndoors_Gfx ((const u16 *)NULL)
#define sFieldMoveStreaksIndoors_Pal ((const u16 *)NULL)
#define sFieldMoveStreaksIndoors_Tilemap ((const u16 *)NULL)
#define sRockFragment_TopLeft ((const u16 *)NULL)
#define sRockFragment_TopRight ((const u16 *)NULL)
#define sRockFragment_BottomLeft ((const u16 *)NULL)
#define sRockFragment_BottomRight ((const u16 *)NULL)
#endif
...
static const void *FieldEffectScript_ReadPtr(const u8 **script)
{
...
static void FieldEffectScript_LoadTiles(const u8 **script)
{
    const struct SpriteSheet * spriteSheet = FieldEffectScript_ReadPtr(script);
...
static void FieldEffectScript_LoadFadedPal(const u8 **script)
{
    const struct SpritePalette * spritePalette = FieldEffectScript_ReadPtr(script);
...
static void FieldEffectScript_CallNative(const u8 **script, u32 *result)
{
    u32 (*func)(void) = FieldEffectScript_ReadPtr(script);
    *result = func();
    *script += sizeof(u32);
}
