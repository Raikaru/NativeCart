...
#ifdef PORTABLE
#include "start_menu_portable_strings.h"
#endif

const u8 gExpandedPlaceholder_Empty[] = { EOS };
const u8 gExpandedPlaceholder_Kun[] = { EOS };
const u8 gExpandedPlaceholder_Chan[] = { EOS };
...
#ifdef PORTABLE
const u8 gText_MenuPokemon[] = { CHAR_P, CHAR_O, CHAR_K, CHAR_E_ACUTE, CHAR_M, CHAR_O, CHAR_N, EOS };
#else
const u8 gText_MenuPokemon[] = _("POKéMON");
#endif
#ifdef PORTABLE
const u8 gText_NewGame[] = { CHAR_N, CHAR_E, CHAR_W, CHAR_SPACE, CHAR_G, CHAR_A, CHAR_M, CHAR_E, EOS };
const u8 gText_Continue[] = { CHAR_C, CHAR_O, CHAR_N, CHAR_T, CHAR_I, CHAR_N, CHAR_U, CHAR_E, EOS };
#else
...
const u8 gText_SaveFileUpdatedSwapBackup[] = _("レポ-トが こうしんされました!\xFBこれいじょう\nレポ-トが かききれないので\xFAバックアップカ-トリッジを\xFAこうかんしてください!\xFBくわしくは\nにんてんどう サ-ビスセンタ- まで\xFAおといあわせ ください");
const u8 gText_FailedUpdateSwapBackup[] = _("レポ-トの こうしんは\nしっぱいしました!\xFBバックアップカ-トリッジを\nこうかんしてください!\xFBくわしくは\nにんてんどう サ-ビスセンタ- まで\xFAおといあわせ ください");
const u8 gText_SaveFileCorrupted[] = _("The save file is corrupted.\xFBThe previous save file will be\nloaded.");
...
#ifdef PORTABLE
const u8 gText_PokedexQuotationMark[] = { CHAR_DBL_QUOTE_RIGHT, EOS }; // Unused
#else
...
ALIGNED(4) const u8 gText_HOFDexRating[] = _("みつけた ポケモン {STR_VAR_1}!\nつかまえた ポケモン {STR_VAR_2}!\xFBオダマキはかせの\nポケモンずかん ひょうか!\xFBオダマキ“どれどれ\xFB");
...
const u8 gText_SaveError_PleaseExchangeBackupMemory[] = _("Save error.\xFBPlease exchange the\nbackup memory.");
#ifndef PORTABLE
...
#ifdef PORTABLE
const u8 gOtherText_Use[] = { CHAR_U, CHAR_S, CHAR_E, EOS };
const u8 gOtherText_Toss[] = { CHAR_T, CHAR_O, CHAR_S, CHAR_S, EOS };
const u8 gOtherText_Register[] = { CHAR_R, CHAR_E, CHAR_G, CHAR_I, CHAR_S, CHAR_T, CHAR_E, CHAR_R, EOS };
const u8 gOtherText_Give[] = { CHAR_G, CHAR_I, CHAR_V, CHAR_E, EOS };
#else
...
#ifdef PORTABLE
const u8 gOtherText_Walk[] = { CHAR_W, CHAR_A, CHAR_L, CHAR_K, EOS };
const u8 gFameCheckerText_Cancel[] = { CHAR_C, CHAR_A, CHAR_N, CHAR_C, CHAR_E, CHAR_L, EOS };
const u8 gOtherText_Exit[] = { CHAR_E, CHAR_X, CHAR_I, CHAR_T, EOS };
#else
const u8 gOtherText_Walk[] = _("WALK");
const u8 gFameCheckerText_Cancel[] = _("CANCEL");
const u8 gOtherText_Exit[] = _("EXIT");
#endif
const u8 gString_Dummy[] = { EOS };
const u8 gText_Cancel7[] = _("キャンセル");
#ifdef PORTABLE
const u8 gText_Item[] = { CHAR_I, CHAR_T, CHAR_E, CHAR_M, EOS };
const u8 gText_Mail[] = { CHAR_M, CHAR_A, CHAR_I, CHAR_L, EOS };
const u8 gText_Take[] = { CHAR_T, CHAR_A, CHAR_K, CHAR_E, EOS };
const u8 gText_Store[] = { CHAR_S, CHAR_T, CHAR_O, CHAR_R, CHAR_E, EOS };
const u8 gOtherText_Check[] = { CHAR_C, CHAR_H, CHAR_E, CHAR_C, CHAR_K, EOS };
const u8 gText_PokeSum_Item_None[] = { CHAR_N, CHAR_O, CHAR_N, CHAR_E, EOS };
const u8 gOtherText_Open[] = { CHAR_O, CHAR_P, CHAR_E, CHAR_N, EOS };
const u8 gOtherText_Deselect[] = { CHAR_D, CHAR_E, CHAR_S, CHAR_E, CHAR_L, CHAR_E, CHAR_B, CHAR_T, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_MaleSymbol[] = { CHAR_MALE, EOS };
const u8 gText_FemaleSymbol[] = { CHAR_FEMALE, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_SelectorArrow2[] = { CHAR_BLACK_TRIANGLE, EOS };
#else
const u8 gText_SelectorArrow2[] = _("▶");
#endif
#ifdef PORTABLE
const u8 gText_YesNo[] = { 0xD3, 0xBF, 0xCD, 0xFE, 0xC8, 0xC9, 0xFF };
#else
const u8 gText_YesNo[] = _("YES\nNO");
#endif
#ifdef PORTABLE
const u8 gText_GoBackToThePreviousMenu[] = {
    CHAR_G, CHAR_o, CHAR_SPACE, CHAR_b, CHAR_a, CHAR_c, CHAR_k, CHAR_SPACE,
    CHAR_t, CHAR_o, CHAR_SPACE, CHAR_t, CHAR_h, CHAR_e, CHAR_NEWLINE,
    CHAR_p, CHAR_r, CHAR_e, CHAR_v, CHAR_i, CHAR_o, CHAR_u, CHAR_s, CHAR_SPACE,
    CHAR_m, CHAR_e, CHAR_n, CHAR_u, CHAR_PERIOD, EOS
};
const u8 gText_WhatWouldYouLikeToDo[] = {
    CHAR_W, CHAR_h, CHAR_a, CHAR_t, CHAR_SPACE, CHAR_w, CHAR_o, CHAR_u, CHAR_l, CHAR_d, CHAR_SPACE,
    CHAR_y, CHAR_o, CHAR_u, CHAR_SPACE, CHAR_l, CHAR_i, CHAR_k, CHAR_e, CHAR_SPACE,
    CHAR_t, CHAR_o, CHAR_SPACE, CHAR_d, CHAR_o, CHAR_QUESTION_MARK, EOS
};
#else
...
#endif
 #ifdef PORTABLE
const u8 gText_MenuPokedex[] = { CHAR_P, CHAR_O, CHAR_K, CHAR_E_ACUTE, CHAR_D, CHAR_E, CHAR_X, EOS };
const u8 gText_MenuBag[] = { CHAR_B, CHAR_A, CHAR_G, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_MenuPlayer[] = { PLACEHOLDER_BEGIN, PLACEHOLDER_ID_PLAYER, EOS };
const u8 gText_MenuSave[] = { CHAR_S, CHAR_A, CHAR_V, CHAR_E, EOS };
const u8 gText_MenuOption[] = { CHAR_O, CHAR_P, CHAR_T, CHAR_I, CHAR_O, CHAR_N, EOS };
const u8 gText_MenuExit[] = { CHAR_E, CHAR_X, CHAR_I, CHAR_T, EOS };
const u8 gText_MenuRetire[] = { CHAR_R, CHAR_E, CHAR_T, CHAR_I, CHAR_R, CHAR_E, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_Items2[] = { CHAR_I, CHAR_T, CHAR_E, CHAR_M, CHAR_S, EOS };
const u8 gText_PokeBalls2[] = { CHAR_P, CHAR_O, CHAR_K, CHAR_E_ACUTE, CHAR_SPACE, CHAR_B, CHAR_A, CHAR_L, CHAR_L, CHAR_S, EOS };
const u8 gText_KeyItems2[] = { CHAR_K, CHAR_E, CHAR_Y, CHAR_SPACE, CHAR_I, CHAR_T, CHAR_E, CHAR_M, CHAR_S, EOS };
const u8 gText_DepositItem[] = { CHAR_D, CHAR_E, CHAR_P, CHAR_O, CHAR_S, CHAR_I, CHAR_T, CHAR_SPACE, CHAR_I, CHAR_T, CHAR_E, CHAR_M, EOS };
const u8 gText_CloseBag[] = { CHAR_C, CHAR_L, CHAR_O, CHAR_S, CHAR_E, CHAR_SPACE, CHAR_B, CHAR_A, CHAR_G, EOS };
#else
...
const u8 gText_ItemfinderResponding[] = _("Huh?\nThe ITEMFINDER's responding!\xFBThere's an item buried around here!{PAUSE_UNTIL_PRESS}");
const u8 gText_ItemfinderShakingWildly[] = _("Oh!\nThe ITEMFINDER's shaking wildly!\xFBThere's an item buried underfoot!\xFB‥ ‥ ‥ ‥ ‥ ‥{PAUSE_UNTIL_PRESS}");
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\xFBWild POKéMON will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\xFBWild POKéMON will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayedPokeFluteCatchy[] = _("Played the POKé FLUTE.\xFBNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
...
#ifdef PORTABLE
const u8 gText_TMCase[] = { CHAR_T, CHAR_M, CHAR_SPACE, CHAR_C, CHAR_A, CHAR_S, CHAR_E, EOS };
const u8 gText_Close[] = { CHAR_C, CHAR_L, CHAR_O, CHAR_S, CHAR_E, EOS };
#else
...
const u8 gText_EmptySpace[] = _("  ");
 #ifdef PORTABLE
const u8 gText_BerryPouch[] = { CHAR_B, CHAR_E, CHAR_R, CHAR_R, CHAR_Y, CHAR_SPACE, CHAR_P, CHAR_O, CHAR_U, CHAR_C, CHAR_H, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_Shift[] = { CHAR_S, CHAR_H, CHAR_I, CHAR_F, CHAR_T, EOS };
const u8 gText_SendOut[] = { CHAR_S, CHAR_E, CHAR_N, CHAR_D, CHAR_SPACE, CHAR_O, CHAR_U, CHAR_T, EOS };
const u8 gText_Switch2[] = { CHAR_S, CHAR_W, CHAR_I, CHAR_T, CHAR_C, CHAR_H, EOS };
const u8 gText_Summary5[] = { CHAR_S, CHAR_U, CHAR_M, CHAR_M, CHAR_A, CHAR_R, CHAR_Y, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_Enter[] = { CHAR_E, CHAR_N, CHAR_T, CHAR_E, CHAR_R, EOS };
const u8 gText_NoEntry[] = { CHAR_N, CHAR_O, CHAR_SPACE, CHAR_E, CHAR_N, CHAR_T, CHAR_R, CHAR_Y, EOS };
const u8 gText_Take2[] = { CHAR_T, CHAR_A, CHAR_K, CHAR_E, EOS };
const u8 gText_Read2[] = { CHAR_R, CHAR_E, CHAR_A, CHAR_D, EOS };
const u8 gText_Trade4[] = { CHAR_T, CHAR_R, CHAR_A, CHAR_D, CHAR_E, EOS };
const u8 gText_ItemEffect_HP[] = { CHAR_H, CHAR_P, EOS };
const u8 gText_ItemEffect_SpAtk[] = { CHAR_S, CHAR_P, CHAR_PERIOD, CHAR_SPACE, CHAR_A, CHAR_T, CHAR_K, EOS };
const u8 gText_ItemEffect_SpDef[] = { CHAR_S, CHAR_P, CHAR_PERIOD, CHAR_SPACE, CHAR_D, CHAR_E, CHAR_F, EOS };
const u8 gText_PartyMenu_OK[] = { CHAR_O, CHAR_K, EOS };
#else
...
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 0x0F}2, and{PAUSE 0x0F}‥ {PAUSE 0x0F}‥ {PAUSE 0x0F}‥ {PAUSE 0x0F}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\xFB{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\xFBAnd...{PAUSE_UNTIL_PRESS}");
...
#ifdef PORTABLE
const u8 gText_ItemEffect_Attack[] = { CHAR_A, CHAR_T, CHAR_T, CHAR_A, CHAR_C, CHAR_K, EOS };
const u8 gText_ItemEffect_Defense[] = { CHAR_D, CHAR_E, CHAR_F, CHAR_E, CHAR_N, CHAR_S, CHAR_E, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_ItemEffect_Speed[] = { CHAR_S, CHAR_P, CHAR_E, CHAR_E, CHAR_D, EOS };
#else
...
const u8 gText_Empty12[] = { EOS };
const u8 gText_CancelBattle[] = _("Cancel the battle?");
 #ifdef PORTABLE
const u8 gText_TurnOff[] = { CHAR_T, CHAR_U, CHAR_R, CHAR_N, CHAR_SPACE, CHAR_O, CHAR_F, CHAR_F, EOS };
#else
const u8 gText_TurnOff[] = _("TURN OFF");
#endif
const u8 gText_Decoration[] = _("もようがえ");
#ifdef PORTABLE
const u8 gText_ItemStorage[] = { CHAR_I, CHAR_T, CHAR_E, CHAR_M, CHAR_SPACE, CHAR_S, CHAR_T, CHAR_O, CHAR_R, CHAR_A, CHAR_G, CHAR_E, EOS };
const u8 gText_Mailbox[] = { CHAR_M, CHAR_A, CHAR_I, CHAR_L, CHAR_B, CHAR_O, CHAR_X, EOS };
const u8 gText_DepositItem2[] = { CHAR_D, CHAR_E, CHAR_P, CHAR_O, CHAR_S, CHAR_I, CHAR_T, CHAR_SPACE, CHAR_I, CHAR_T, CHAR_E, CHAR_M, EOS };
const u8 gText_WithdrawItem2[] = { CHAR_W, CHAR_I, CHAR_T, CHAR_H, CHAR_D, CHAR_R, CHAR_A, CHAR_W, CHAR_SPACE, CHAR_I, CHAR_T, CHAR_E, CHAR_M, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_StoreItemsInThePC[] = {
    CHAR_S, CHAR_t, CHAR_o, CHAR_r, CHAR_e, CHAR_SPACE, CHAR_i, CHAR_t, CHAR_e, CHAR_m, CHAR_s, CHAR_SPACE,
    CHAR_i, CHAR_n, CHAR_SPACE, CHAR_t, CHAR_h, CHAR_e, CHAR_SPACE, CHAR_P, CHAR_C, CHAR_PERIOD, EOS
};
const u8 gText_TakeOutItemsFromThePC[] = {
    CHAR_T, CHAR_a, CHAR_k, CHAR_e, CHAR_SPACE, CHAR_o, CHAR_u, CHAR_t, CHAR_SPACE, CHAR_i, CHAR_t, CHAR_e, CHAR_m, CHAR_s, CHAR_SPACE,
    CHAR_f, CHAR_r, CHAR_o, CHAR_m, CHAR_SPACE, CHAR_t, CHAR_h, CHAR_e, CHAR_SPACE, CHAR_P, CHAR_C, CHAR_PERIOD, EOS
};
#else
...
#ifdef PORTABLE
const u8 gText_ThereAreNoItems[] = {
    CHAR_T, CHAR_h, CHAR_e, CHAR_r, CHAR_e, CHAR_SPACE, CHAR_a, CHAR_r, CHAR_e, CHAR_SPACE, CHAR_n, CHAR_o, CHAR_SPACE,
    CHAR_i, CHAR_t, CHAR_e, CHAR_m, CHAR_s, CHAR_PERIOD,
    EXT_CTRL_CODE_BEGIN, EXT_CTRL_CODE_PAUSE_UNTIL_PRESS, EOS
};
#else
...
#ifdef PORTABLE
const u8 gOtherText_Read[] = { CHAR_R, CHAR_E, CHAR_A, CHAR_D, EOS };
const u8 gOtherText_MoveToBag[] = { CHAR_M, CHAR_O, CHAR_V, CHAR_E, CHAR_SPACE, CHAR_T, CHAR_O, CHAR_SPACE, CHAR_B, CHAR_A, CHAR_G, EOS };
const u8 gOtherText_Give2[] = { CHAR_G, CHAR_I, CHAR_V, CHAR_E, EOS };
const u8 gText_TheresNoMailHere[] = {
    CHAR_T, CHAR_h, CHAR_e, CHAR_r, CHAR_e, CHAR_SGL_QUOTE_RIGHT, CHAR_s, CHAR_SPACE, CHAR_n, CHAR_o, CHAR_SPACE,
    CHAR_M, CHAR_A, CHAR_I, CHAR_L, CHAR_SPACE, CHAR_h, CHAR_e, CHAR_r, CHAR_e, CHAR_PERIOD,
    EXT_CTRL_CODE_BEGIN, EXT_CTRL_CODE_PAUSE_UNTIL_PRESS, EOS
};
const u8 gText_WhatWouldYouLikeToDoWithPlayersMail[] = {
    CHAR_W, CHAR_h, CHAR_a, CHAR_t, CHAR_SPACE, CHAR_w, CHAR_o, CHAR_u, CHAR_l, CHAR_d, CHAR_SPACE,
    CHAR_y, CHAR_o, CHAR_u, CHAR_SPACE, CHAR_l, CHAR_i, CHAR_k, CHAR_e, CHAR_SPACE, CHAR_t, CHAR_o, CHAR_SPACE,
    CHAR_d, CHAR_o, CHAR_SPACE, CHAR_w, CHAR_i, CHAR_t, CHAR_h, CHAR_NEWLINE,
    PLACEHOLDER_BEGIN, PLACEHOLDER_ID_STRING_VAR_1, CHAR_SGL_QUOTE_RIGHT, CHAR_s, CHAR_SPACE,
    CHAR_M, CHAR_A, CHAR_I, CHAR_L, CHAR_QUESTION_MARK, EOS
};
const u8 gText_MessageWillBeLost[] = {
    CHAR_T, CHAR_h, CHAR_e, CHAR_SPACE, CHAR_m, CHAR_e, CHAR_s, CHAR_s, CHAR_a, CHAR_g, CHAR_e, CHAR_SPACE,
    CHAR_w, CHAR_i, CHAR_l, CHAR_l, CHAR_SPACE, CHAR_b, CHAR_e, CHAR_SPACE, CHAR_l, CHAR_o, CHAR_s, CHAR_t, CHAR_PERIOD,
    CHAR_NEWLINE,
    CHAR_I, CHAR_s, CHAR_SPACE, CHAR_t, CHAR_h, CHAR_a, CHAR_t, CHAR_SPACE, CHAR_o, CHAR_k, CHAR_a, CHAR_y, CHAR_QUESTION_MARK, EOS
};
const u8 gText_BagIsFull[] = {
    CHAR_T, CHAR_h, CHAR_e, CHAR_SPACE, CHAR_B, CHAR_A, CHAR_G, CHAR_SPACE, CHAR_i, CHAR_s, CHAR_SPACE,
    CHAR_f, CHAR_u, CHAR_l, CHAR_l, CHAR_PERIOD,
    EXT_CTRL_CODE_BEGIN, EXT_CTRL_CODE_PAUSE_UNTIL_PRESS, EOS
};
const u8 gText_MailReturnedToBagMessageErased[] = {
    CHAR_T, CHAR_h, CHAR_e, CHAR_SPACE, CHAR_M, CHAR_A, CHAR_I, CHAR_L, CHAR_SPACE, CHAR_w, CHAR_a, CHAR_s, CHAR_SPACE,
    CHAR_r, CHAR_e, CHAR_t, CHAR_u, CHAR_r, CHAR_n, CHAR_e, CHAR_d, CHAR_SPACE, CHAR_t, CHAR_o, CHAR_SPACE, CHAR_t, CHAR_h, CHAR_e, CHAR_SPACE,
    CHAR_B, CHAR_A, CHAR_G, CHAR_NEWLINE,
    CHAR_w, CHAR_i, CHAR_t, CHAR_h, CHAR_SPACE, CHAR_i, CHAR_t, CHAR_s, CHAR_SPACE, CHAR_m, CHAR_e, CHAR_s, CHAR_s, CHAR_a, CHAR_g, CHAR_e, CHAR_SPACE,
    CHAR_e, CHAR_r, CHAR_a, CHAR_s, CHAR_e, CHAR_d, CHAR_PERIOD,
    EXT_CTRL_CODE_BEGIN, EXT_CTRL_CODE_PAUSE_UNTIL_PRESS, EOS
};
const u8 gText_WithdrawItem[] = { CHAR_W, CHAR_I, CHAR_T, CHAR_H, CHAR_D, CHAR_R, CHAR_A, CHAR_W, CHAR_NEWLINE, CHAR_I, CHAR_T, CHAR_E, CHAR_M, EOS };
const u8 gText_Withdraw[] = { CHAR_W, CHAR_I, CHAR_T, CHAR_H, CHAR_D, CHAR_R, CHAR_A, CHAR_W, EOS };
const u8 gText_ReturnToPC[] = { CHAR_R, CHAR_e, CHAR_t, CHAR_u, CHAR_r, CHAR_n, CHAR_SPACE, CHAR_t, CHAR_o, CHAR_SPACE, CHAR_t, CHAR_h, CHAR_e, CHAR_SPACE, CHAR_P, CHAR_C, CHAR_PERIOD, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_ItemsPocket[] = { CHAR_I, CHAR_T, CHAR_E, CHAR_M, CHAR_S, CHAR_SPACE, CHAR_P, CHAR_O, CHAR_C, CHAR_K, CHAR_E, CHAR_T, EOS };
const u8 gText_KeyItemsPocket[] = { CHAR_K, CHAR_E, CHAR_Y, CHAR_SPACE, CHAR_I, CHAR_T, CHAR_E, CHAR_M, CHAR_S, CHAR_SPACE, CHAR_P, CHAR_O, CHAR_C, CHAR_K, CHAR_E, CHAR_T, EOS };
const u8 gText_PokeBallsPocket[] = { CHAR_P, CHAR_O, CHAR_K, CHAR_E_ACUTE, CHAR_SPACE, CHAR_B, CHAR_A, CHAR_L, CHAR_L, CHAR_S, CHAR_SPACE, CHAR_P, CHAR_O, CHAR_C, CHAR_K, CHAR_E, CHAR_T, EOS };
const u8 gText_TmCase[] = { CHAR_T, CHAR_M, CHAR_SPACE, CHAR_C, CHAR_A, CHAR_S, CHAR_E, EOS };
const u8 gText_BerryPouch_2[] = { CHAR_B, CHAR_E, CHAR_R, CHAR_R, CHAR_Y, CHAR_SPACE, CHAR_P, CHAR_O, CHAR_U, CHAR_C, CHAR_H, EOS };
const u8 gText_Other[] = { CHAR_O, CHAR_T, CHAR_H, CHAR_E, CHAR_R, EOS };
#else
...
const u8 gText_EmptyLinkService1[] = { EOS };
const u8 gText_EmptyLinkService2[] = { EOS };
const u8 gText_ListenToExplanation[] = _("せつめいを きく");
const u8 gText_RecordCorner[] = { EOS }; // Dummied
...
const u8 gText_Multichoice_Empty2[] = { EOS };
const u8 gText_Multichoice_Empty1[] = { EOS };
...
#ifdef PORTABLE
const u8 gPCText_Cancel[] = { CHAR_C, CHAR_A, CHAR_N, CHAR_C, CHAR_E, CHAR_L, EOS };
const u8 gPCText_Store[] = { CHAR_S, CHAR_T, CHAR_O, CHAR_R, CHAR_E, EOS };
const u8 gPCText_Withdraw[] = { CHAR_W, CHAR_I, CHAR_T, CHAR_H, CHAR_D, CHAR_R, CHAR_A, CHAR_W, EOS };
const u8 gPCText_Shift[] = { CHAR_S, CHAR_H, CHAR_I, CHAR_F, CHAR_T, EOS };
const u8 gPCText_Move[] = { CHAR_M, CHAR_O, CHAR_V, CHAR_E, EOS };
const u8 gPCText_Place[] = { CHAR_P, CHAR_L, CHAR_A, CHAR_C, CHAR_E, EOS };
const u8 gPCText_Summary[] = { CHAR_S, CHAR_U, CHAR_M, CHAR_M, CHAR_A, CHAR_R, CHAR_Y, EOS };
const u8 gPCText_Release[] = { CHAR_R, CHAR_E, CHAR_L, CHAR_E, CHAR_A, CHAR_S, CHAR_E, EOS };
const u8 gPCText_Mark[] = { CHAR_M, CHAR_A, CHAR_R, CHAR_K, EOS };
const u8 gPCText_Name[] = { CHAR_N, CHAR_A, CHAR_M, CHAR_E, EOS };
const u8 gPCText_Jump[] = { CHAR_J, CHAR_U, CHAR_M, CHAR_P, EOS };
const u8 gPCText_Wallpaper[] = { CHAR_W, CHAR_A, CHAR_L, CHAR_L, CHAR_P, CHAR_A, CHAR_P, CHAR_E, CHAR_R, EOS };
const u8 gPCText_Take[] = { CHAR_T, CHAR_A, CHAR_K, CHAR_E, EOS };
const u8 gPCText_Give[] = { CHAR_G, CHAR_I, CHAR_V, CHAR_E, EOS };
const u8 gPCText_Switch[] = { CHAR_S, CHAR_W, CHAR_I, CHAR_T, CHAR_C, CHAR_H, EOS };
const u8 gPCText_Bag[] = { CHAR_B, CHAR_A, CHAR_G, EOS };
const u8 gPCText_Info[] = { CHAR_I, CHAR_N, CHAR_F, CHAR_O, EOS };
const u8 gPCText_Scenery1[] = { CHAR_S, CHAR_C, CHAR_E, CHAR_N, CHAR_E, CHAR_R, CHAR_Y, CHAR_SPACE, CHAR_1, EOS };
const u8 gPCText_Scenery2[] = { CHAR_S, CHAR_C, CHAR_E, CHAR_N, CHAR_E, CHAR_R, CHAR_Y, CHAR_SPACE, CHAR_2, EOS };
const u8 gPCText_Scenery3[] = { CHAR_S, CHAR_C, CHAR_E, CHAR_N, CHAR_E, CHAR_R, CHAR_Y, CHAR_SPACE, CHAR_3, EOS };
const u8 gPCText_Etcetera[] = { CHAR_E, CHAR_T, CHAR_C, CHAR_E, CHAR_T, CHAR_E, CHAR_R, CHAR_A, EOS };
const u8 gPCText_Forest[] = { CHAR_F, CHAR_O, CHAR_R, CHAR_E, CHAR_S, CHAR_T, EOS };
const u8 gPCText_City[] = { CHAR_C, CHAR_I, CHAR_T, CHAR_Y, EOS };
const u8 gPCText_Desert[] = { CHAR_D, CHAR_E, CHAR_S, CHAR_E, CHAR_R, CHAR_T, EOS };
const u8 gPCText_Savanna[] = { CHAR_S, CHAR_A, CHAR_V, CHAR_A, CHAR_N, CHAR_N, CHAR_A, EOS };
const u8 gPCText_Crag[] = { CHAR_C, CHAR_R, CHAR_A, CHAR_G, EOS };
const u8 gPCText_Volcano[] = { CHAR_V, CHAR_O, CHAR_L, CHAR_C, CHAR_A, CHAR_N, CHAR_O, EOS };
const u8 gPCText_Snow[] = { CHAR_S, CHAR_N, CHAR_O, CHAR_W, EOS };
const u8 gPCText_Cave[] = { CHAR_C, CHAR_A, CHAR_V, CHAR_E, EOS };
const u8 gPCText_Beach[] = { CHAR_B, CHAR_E, CHAR_A, CHAR_C, CHAR_H, EOS };
const u8 gPCText_Seafloor[] = { CHAR_S, CHAR_E, CHAR_A, CHAR_F, CHAR_L, CHAR_O, CHAR_O, CHAR_R, EOS };
const u8 gPCText_River[] = { CHAR_R, CHAR_I, CHAR_V, CHAR_E, CHAR_R, EOS };
const u8 gPCText_Sky[] = { CHAR_S, CHAR_K, CHAR_Y, EOS };
const u8 gPCText_PolkaDot[] = { CHAR_S, CHAR_T, CHAR_A, CHAR_R, CHAR_S, EOS };
const u8 gPCText_Pokecenter[] = { CHAR_P, CHAR_O, CHAR_K, CHAR_E_ACUTE, CHAR_C, CHAR_E, CHAR_N, CHAR_T, CHAR_E, CHAR_R, EOS };
const u8 gPCText_Machine[] = { CHAR_T, CHAR_I, CHAR_L, CHAR_E, CHAR_S, EOS };
const u8 gPCText_Simple[] = { CHAR_S, CHAR_I, CHAR_M, CHAR_P, CHAR_L, CHAR_E, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_YourName[] = { CHAR_Y, CHAR_O, CHAR_U, CHAR_R, CHAR_SPACE, CHAR_N, CHAR_A, CHAR_M, CHAR_E, CHAR_QUESTION_MARK, EOS };
const u8 gText_BoxName[] = { CHAR_B, CHAR_O, CHAR_X, CHAR_SPACE, CHAR_N, CHAR_A, CHAR_M, CHAR_E, CHAR_QUESTION_MARK, EOS };
#else
const u8 gText_YourName[] = _("YOUR NAME?");
const u8 gText_BoxName[] = _("BOX NAME?");
#endif
#ifdef PORTABLE
const u8 gText_PkmnsNickname[] = { 0xB4, 0xE7, 0x00, 0xE2, 0xDD, 0xD7, 0xDF, 0xE2, 0xD5, 0xE1, 0xD9, 0xAC, 0xFF };
#else
const u8 gText_PkmnsNickname[] = _("'s nickname?");
#endif
#ifdef PORTABLE
const u8 gText_RivalsName[] = { CHAR_R, CHAR_I, CHAR_V, CHAR_A, CHAR_L, CHAR_SGL_QUOTE_RIGHT, CHAR_s, CHAR_SPACE, CHAR_N, CHAR_A, CHAR_M, CHAR_E, CHAR_QUESTION_MARK, EOS };
#else
const u8 gText_RivalsName[] = _("RIVAL's NAME?");
#endif
#ifdef PORTABLE
const u8 gText_MoveOkBack[] = {
    0xF8, 0x0C, 0xC7, 0xC9, 0xD0, 0xBF, 0x00,
    0xF8, 0x00, 0xC9, 0xC5, 0x00,
    0xF8, 0x01, 0xBC, 0xBB, 0xBD, 0xC5,
    0xFF
};
#else
const u8 gText_MoveOkBack[] = _("{DPAD_ANY}MOVE {A_BUTTON}OK {B_BUTTON}BACK");
#endif
const u8 gText_AlphabetUpperLower[] = { EOS };
...
#ifdef PORTABLE
const u8 gText_TrainerCardName[] = { CHAR_N, CHAR_A, CHAR_M, CHAR_E, CHAR_COLON, CHAR_SPACE, EOS };
const u8 gText_TrainerCardIDNo[] = { CHAR_I, CHAR_D, CHAR_N, CHAR_o, CHAR_PERIOD, EOS };
const u8 gText_TrainerCardMoney[] = { CHAR_M, CHAR_O, CHAR_N, CHAR_E, CHAR_Y, EOS };
const u8 gText_TrainerCardYen[] = { CHAR_CURRENCY, EOS };
const u8 gText_TrainerCardPokedex[] = { CHAR_P, CHAR_O, CHAR_K, CHAR_E_ACUTE, CHAR_D, CHAR_E, CHAR_X, EOS };
#else
...
#endif
const u8 gText_TrainerCardNull[] = { EOS };
#ifdef PORTABLE
const u8 gText_Colon2[] = { CHAR_COLON, EOS };
#else
const u8 gText_Colon2[] = _(":");
#endif
const u8 gText_Points[] = _("てん");
#ifdef PORTABLE
const u8 gText_TrainerCardTime[] = { CHAR_T, CHAR_I, CHAR_M, CHAR_E, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_Var1sTrainerCard[] = { CHAR_SGL_QUOTE_RIGHT, CHAR_s, CHAR_SPACE, CHAR_T, CHAR_R, CHAR_A, CHAR_I, CHAR_N, CHAR_E, CHAR_R, CHAR_SPACE, CHAR_C, CHAR_A, CHAR_R, CHAR_D, EOS };
const u8 gText_HallOfFameDebut[] = { CHAR_H, CHAR_A, CHAR_L, CHAR_L, CHAR_SPACE, CHAR_O, CHAR_F, CHAR_SPACE, CHAR_F, CHAR_A, CHAR_M, CHAR_E, CHAR_SPACE, CHAR_D, CHAR_E, CHAR_B, CHAR_U, CHAR_T, CHAR_SPACE, CHAR_SPACE, EOS };
const u8 gText_LinkBattles[] = { CHAR_L, CHAR_I, CHAR_N, CHAR_K, CHAR_SPACE, CHAR_B, CHAR_A, CHAR_T, CHAR_T, CHAR_L, CHAR_E, CHAR_S, EOS };
const u8 gText_LinkCableBattles[] = { CHAR_L, CHAR_I, CHAR_N, CHAR_K, CHAR_SPACE, CHAR_C, CHAR_A, CHAR_B, CHAR_L, CHAR_E, CHAR_SPACE, CHAR_B, CHAR_A, CHAR_T, CHAR_T, CHAR_L, CHAR_E, CHAR_S, EOS };
const u8 gText_WinLossRatio[] = { CHAR_W, CHAR_COLON, EXT_CTRL_CODE_BEGIN, EXT_CTRL_CODE_CLEAR_TO, 0x30, CHAR_L, CHAR_COLON, EOS };
const u8 gText_PokemonTrades[] = { CHAR_P, CHAR_O, CHAR_K, CHAR_E_ACUTE, CHAR_M, CHAR_O, CHAR_N, CHAR_SPACE, CHAR_T, CHAR_R, CHAR_A, CHAR_D, CHAR_E, CHAR_S, EOS };
const u8 gText_UnionRoomTradesBattles[] = { CHAR_U, CHAR_N, CHAR_I, CHAR_O, CHAR_N, CHAR_SPACE, CHAR_T, CHAR_R, CHAR_A, CHAR_D, CHAR_E, CHAR_S, CHAR_SPACE, CHAR_AMPERSAND, CHAR_SPACE, CHAR_B, CHAR_A, CHAR_T, CHAR_T, CHAR_L, CHAR_E, CHAR_S, EOS };
const u8 gText_BerryCrushes[] = { CHAR_B, CHAR_E, CHAR_R, CHAR_R, CHAR_Y, CHAR_SPACE, CHAR_C, CHAR_R, CHAR_U, CHAR_S, CHAR_H, EOS };
const u8 gText_WaitingTrainerFinishReading[] = {
    CHAR_W, CHAR_a, CHAR_i, CHAR_t, CHAR_i, CHAR_n, CHAR_g, CHAR_SPACE, CHAR_f, CHAR_o, CHAR_r, CHAR_SPACE, CHAR_t, CHAR_h, CHAR_e, CHAR_SPACE, CHAR_o, CHAR_t, CHAR_h, CHAR_e, CHAR_r, CHAR_SPACE, CHAR_T, CHAR_R, CHAR_A, CHAR_I, CHAR_N, CHAR_E, CHAR_R, CHAR_SPACE, CHAR_t, CHAR_o,
    CHAR_NEWLINE,
    CHAR_f, CHAR_i, CHAR_n, CHAR_i, CHAR_s, CHAR_h, CHAR_SPACE, CHAR_r, CHAR_e, CHAR_a, CHAR_d, CHAR_i, CHAR_n, CHAR_g, CHAR_SPACE, CHAR_y, CHAR_o, CHAR_u, CHAR_r, CHAR_SPACE, CHAR_T, CHAR_R, CHAR_A, CHAR_I, CHAR_N, CHAR_E, CHAR_R, CHAR_SPACE, CHAR_C, CHAR_A, CHAR_R, CHAR_D, CHAR_PERIOD, EOS
};
#else
...
#endif
#ifdef PORTABLE
const u8 gText_Option[] = { CHAR_O, CHAR_P, CHAR_T, CHAR_I, CHAR_O, CHAR_N, EOS };
const u8 gText_TextSpeed[] = { CHAR_T, CHAR_E, CHAR_X, CHAR_T, CHAR_SPACE, CHAR_S, CHAR_P, CHAR_E, CHAR_E, CHAR_D, EOS };
const u8 gText_BattleScene[] = { CHAR_B, CHAR_A, CHAR_T, CHAR_T, CHAR_L, CHAR_E, CHAR_SPACE, CHAR_S, CHAR_C, CHAR_E, CHAR_N, CHAR_E, EOS };
const u8 gText_BattleStyle[] = { CHAR_B, CHAR_A, CHAR_T, CHAR_T, CHAR_L, CHAR_E, CHAR_SPACE, CHAR_S, CHAR_T, CHAR_Y, CHAR_L, CHAR_E, EOS };
const u8 gText_Sound[] = { CHAR_S, CHAR_O, CHAR_U, CHAR_N, CHAR_D, EOS };
const u8 gText_ButtonMode[] = { CHAR_B, CHAR_U, CHAR_T, CHAR_T, CHAR_O, CHAR_N, CHAR_SPACE, CHAR_M, CHAR_O, CHAR_D, CHAR_E, EOS };
const u8 gText_Frame[] = { CHAR_F, CHAR_R, CHAR_A, CHAR_M, CHAR_E, EOS };
const u8 gText_OptionMenuCancel[] = { CHAR_C, CHAR_A, CHAR_N, CHAR_C, CHAR_E, CHAR_L, EOS };
const u8 gText_TextSpeedSlow[] = { CHAR_S, CHAR_L, CHAR_O, CHAR_W, EOS };
const u8 gText_TextSpeedMid[] = { CHAR_M, CHAR_I, CHAR_D, EOS };
const u8 gText_TextSpeedFast[] = { CHAR_F, CHAR_A, CHAR_S, CHAR_T, EOS };
const u8 gText_BattleSceneOn[] = { CHAR_O, CHAR_N, EOS };
const u8 gText_BattleSceneOff[] = { CHAR_O, CHAR_F, CHAR_F, EOS };
const u8 gText_BattleStyleShift[] = { CHAR_S, CHAR_H, CHAR_I, CHAR_F, CHAR_T, EOS };
const u8 gText_BattleStyleSet[] = { CHAR_S, CHAR_E, CHAR_T, EOS };
const u8 gText_SoundMono[] = { CHAR_M, CHAR_O, CHAR_N, CHAR_O, EOS };
const u8 gText_SoundStereo[] = { CHAR_S, CHAR_T, CHAR_E, CHAR_R, CHAR_E, CHAR_O, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_ButtonTypeHelp[] = { CHAR_H, CHAR_E, CHAR_L, CHAR_P, EOS };
const u8 gText_ButtonTypeLEqualsA[] = { CHAR_L, CHAR_EQUALS, CHAR_A, EOS };
const u8 gText_ButtonTypeLR[] = { CHAR_L, CHAR_R, EOS };
const u8 gText_FrameType[] = { CHAR_T, CHAR_Y, CHAR_P, CHAR_E, EOS };
#else
...
const u8 gText_Poof[] = _("Poof!\xFB");
const u8 gText_MonForgotMove[] = _("{DYNAMIC 0x00} forgot\n{DYNAMIC 0x01}.\xFB");
const u8 gText_And[] = _("And‥\xFB");
const u8 gText_MachineSet[] = _("Machine set!\xFB");
...
#ifdef PORTABLE
const u8 gText_Player[] = { CHAR_P, CHAR_L, CHAR_A, CHAR_Y, CHAR_E, CHAR_R, EOS };
const u8 gText_Time[] = { CHAR_T, CHAR_I, CHAR_M, CHAR_E, EOS };
#else
...
#ifdef PORTABLE
const u8 gText_Pokedex[] = { CHAR_P, CHAR_O, CHAR_K, CHAR_E_ACUTE, CHAR_D, CHAR_E, CHAR_X, EOS };
#else
const u8 gText_Pokedex[] = _("POKéDEX");
#endif
const u8 gTextJPDummy_Hiki[] = { EOS };
#ifdef PORTABLE
const u8 gText_Badges[] = { CHAR_B, CHAR_A, CHAR_D, CHAR_G, CHAR_E, CHAR_S, EOS };
#else
const u8 gText_Badges[] = _("BADGES");
#endif
const u8 gTextJPDummy_Ko[] = { EOS };
...
ALIGNED(4) const u8 gText_BerryCrush_TimeUp[] = _("Time's up.\xFBGood BERRY POWDER could not be\nmade…\xFB");
...
const u8 gJPText_MysteryGift[] = { EOS };
const u8 gJPText_DecideStop[] = { EOS };
const u8 gJPText_ReceiveMysteryGiftWithEReader[] = { EOS };
const u8 gJPText_SelectConnectFromEReaderMenu[] = { EOS };
const u8 gJPText_SelectConnectWithGBA[] = { EOS };
const u8 gJPText_SelectConnectAndPressA[] = _("カ-ドeリ-ダ-{PLUS}の ‘つうしん'を\nえらんで Aボタンを おしてください");
const u8 gJPText_LinkIsIncorrect[] = { EOS };
const u8 gJPText_CardReadingHasBeenHalted[] = { EOS };
const u8 gJPText_UnableConnectWithEReader[] = _("カ-ドeリ-ダ-{PLUS}と\nつうしん できません");
const u8 gJPText_Connecting[] = { EOS };
const u8 gJPText_ConnectionErrorCheckLink[] = { EOS };
const u8 gJPText_ConnectionErrorTryAgain[] = { EOS };
const u8 gJPText_AllowEReaderToLoadCard[] = { EOS };
const u8 gJPText_ConnectionComplete[] = { EOS };
const u8 gJPText_NewTrainerHasComeToSevii[] = { EOS };
const u8 gJPText_PleaseWaitAMoment[] = { EOS };
const u8 gJPText_WriteErrorUnableToSaveData[] = { EOS };
...
const u8 gText_Empty1[] = { EOS };
const u8 gText_Empty2[] = { EOS };
const u8 gText_Empty3[] = { EOS };
const u8 gText_Empty4[] = { EOS };
const u8 gText_Empty5[] = { EOS };
const u8 gText_Empty6[] = { EOS };
const u8 gText_Empty7[] = { EOS };
const u8 gText_Empty8[] = { EOS };
const u8 gText_Empty9[] = { EOS };
const u8 gText_Empty10[] = { EOS };
const u8 gText_Empty11[] = { EOS };
...
const u8 gText_MonIsTryingToLearnMove[] = _("{STR_VAR_1} is trying to learn\n{STR_VAR_2}.\xFBBut {STR_VAR_1} can't learn more\nthan four moves.\xFBDelete an older move to make\nroom for {STR_VAR_2}?");
const u8 gText_StopLearningMove[] = _("Stop learning {STR_VAR_2}?");
const u8 gText_1_2_and_Poof[] = _("{PAUSE 0x20}1, {PAUSE 0x0F}2, and {PAUSE 0x0F}‥ {PAUSE 0x0F}‥ {PAUSE 0x0F}‥ {PAUSE 0x0F}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\xFB");
const u8 gText_MonForgotOldMoveAndMonLearnedNewMove[] = _("{STR_VAR_1} forgot {STR_VAR_3}.\xFBAnd‥\xFB{STR_VAR_1}\nlearned {STR_VAR_2}.");
const u8 gText_GiveUpTryingToTeachNewMove[] = _("Give up trying to teach a new\nmove to {STR_VAR_1}?");
const u8 gText_WhichMoveShouldBeForgotten[] = _("Which move should be forgotten?\xFB");
