...
#define BATTLE_ENEMY_SHADOW_GFX gEnemyMonShadow_Gfx_Portable
#else
#define BATTLE_ENEMY_SHADOW_GFX gEnemyMonShadow_Gfx
#endif
...
{
    .data = BATTLE_ENEMY_SHADOW_GFX, .size = 0x80, .tag = GFXTAG_SHADOW
};
