...
static void TraceTitleScreenState(const char *tag, s16 *data)
{
    ...
    snprintf(buffer, sizeof(buffer), "%s: scene=%d state=%d a=%d b=%d c=%d d=%d",
...
#define gGraphics_TitleScreen_BackgroundPals gGraphics_TitleScreen_BackgroundPals_Portable
...
#if defined(FIRERED)
#define sFlames_Pal sFlames_Pal_Portable
#define sFlames_Gfx sFlames_Gfx_Portable
#define sBlankFlames_Gfx sBlankFlames_Gfx_Portable
#endif
#else
...
{
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_TitleScreenRun: enter");
#endif
    RunTasks();
    AnimateSprites();
    BuildOamBuffer();
...
#ifdef PORTABLE
    TraceTitleScreenState("Task_TitleScreenMain", data);
#endif
...
{
#ifdef PORTABLE
    TraceTitleScreenState("SetTitleScreenScene_Cry", data);
#endif
    switch (tState)
    {
    case 0:
    ...
    case 2:
        ...
        {
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: pre-SeedRngAndSetTrainerId");
#endif
            SeedRngAndSetTrainerId();
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: post-SeedRngAndSetTrainerId");
            firered_runtime_trace_external("SetTitleScreenScene_Cry: pre-SetSaveBlocksPointers");
#endif
            SetSaveBlocksPointers();
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: post-SetSaveBlocksPointers");
            firered_runtime_trace_external("SetTitleScreenScene_Cry: pre-ResetMenuAndMonGlobals");
#endif
            ResetMenuAndMonGlobals();
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: post-ResetMenuAndMonGlobals");
            firered_runtime_trace_external("SetTitleScreenScene_Cry: pre-Save_ResetSaveCounters");
#endif
            Save_ResetSaveCounters();
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: post-Save_ResetSaveCounters");
            firered_runtime_trace_external("SetTitleScreenScene_Cry: pre-LoadGameSave");
#endif
            LoadGameSave(SAVE_NORMAL);
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: post-LoadGameSave");
#endif
            if (gSaveFileStatus == SAVE_STATUS_EMPTY || gSaveFileStatus == SAVE_STATUS_INVALID)
                Sav2_ClearSetDefault();
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: pre-SetPokemonCryStereo");
#endif
            SetPokemonCryStereo(gSaveBlock2Ptr->optionsSound);
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: post-SetPokemonCryStereo");
            firered_runtime_trace_external("SetTitleScreenScene_Cry: pre-InitHeap");
#endif
            InitHeap(gHeap, HEAP_SIZE);
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: post-InitHeap");
            firered_runtime_trace_external("SetTitleScreenScene_Cry: pre-CB2_InitMainMenu");
#endif
            SetMainCallback2(CB2_InitMainMenu);
#ifdef PORTABLE
            firered_runtime_trace_external("SetTitleScreenScene_Cry: post-CB2_InitMainMenu");
#endif
            DestroyTask(FindTaskIdByFunc(Task_TitleScreenMain));
        }
        break;
