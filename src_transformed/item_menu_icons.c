...
#include "item_icons_portable_assets.h"
#define gBagMale_Gfx gBagMale_Gfx_Portable
#define gBagFemale_Gfx gBagFemale_Gfx_Portable
#define gBag_Pal gBag_Pal_Portable
#define gSwapLine_Gfx gSwapLine_Gfx_Portable
#define gSwapLine_Pal gSwapLine_Pal_Portable
#endif
...
const u32 *GetItemIconGfxPtr(u16 itemId, u8 attrId)
{
    ...
    {
    case ITEMS_COUNT:
        return (attrId == ITEMICON_PAL) ? gItemIconPalette_ReturnToFieldArrow_Portable : gItemIcon_ReturnToFieldArrow_Portable;
    case ITEM_POTION:
        return (attrId == ITEMICON_PAL) ? gItemIconPalette_Potion_Portable : gItemIcon_Potion_Portable;
    case ITEM_POKE_BALL:
        return (attrId == ITEMICON_PAL) ? gItemIconPalette_PokeBall_Portable : gItemIcon_PokeBall_Portable;
    case ITEM_NONE:
    default:
        return (attrId == ITEMICON_PAL) ? gItemIconPalette_QuestionMark_Portable : gItemIcon_QuestionMark_Portable;
    }
#endif
