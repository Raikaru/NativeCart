...
// Unused
#define sMenu_Pal ((const u16 *)NULL)
#define sMenu_Tilemap ((const u32 *)NULL)
#define sPkmnData_Tilemap ((const u16 *)NULL)
#define sScrollingBg_Pal ((const u16 *)NULL)
#define sScrollingBgMoveItems_Pal ((const u16 *)NULL)
#define sCloseBoxButton_Tilemap ((const u16 *)NULL)
#define sPartySlotFilled_Tilemap ((const u16 *)NULL)
#define sPartySlotEmpty_Tilemap ((const u16 *)NULL)
#define sPokeStorageMisc2Pal ((const u16 *)NULL)
#define sWaveform_Gfx ((const u16 *)NULL)
