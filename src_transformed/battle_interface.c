...
#define gBattleInterface_PartySummaryBar_Gfx gBattleInterface_PartySummaryBar_Gfx_Portable
#endif
...
#define BATTLE_INTERFACE_GFX_TILE_PTR(tileNum) (gBattleInterface_Gfx + ((tileNum) * TILE_SIZE_4BPP))
...
static const struct SpriteSheet sPartySummaryBallSpriteSheets[] = {
    {BATTLE_INTERFACE_GFX_TILE_PTR(B_INTERFACE_GFX_BALL_PARTY_SUMMARY), 4 * TILE_SIZE_4BPP, TAG_PARTY_SUMMARY_BALL_PLAYER_TILE},
    {BATTLE_INTERFACE_GFX_TILE_PTR(B_INTERFACE_GFX_BALL_PARTY_SUMMARY), 4 * TILE_SIZE_4BPP, TAG_PARTY_SUMMARY_BALL_OPPONENT_TILE}
};
...
{
    return BATTLE_INTERFACE_GFX_TILE_PTR(elementId);
}
...
static u8 *AddTextPrinterAndCreateWindowOnHealthbox(const u8 *str, u32 x, u32 y, u32 *windowId)
{
    ...
    *windowId = winId;
    return GetWindowTileDataAddress(winId);
}
