...
#ifdef PORTABLE
const u8 gText_NamingScreenKeyboard_abcdef[] = { 0xFC, 0x11, 11, CHAR_a, 0xFC, 0x11, 6, CHAR_b, 0xFC, 0x11, 6, CHAR_c, 0xFC, 0x11, 26, CHAR_d, 0xFC, 0x11, 6, CHAR_e, 0xFC, 0x11, 6, CHAR_f, 0xFC, 0x11, 6, CHAR_SPACE, 0xFC, 0x11, 26, CHAR_PERIOD, EOS };
const u8 gText_NamingScreenKeyboard_ghijkl[] = { 0xFC, 0x11, 11, CHAR_g, 0xFC, 0x11, 6, CHAR_h, 0xFC, 0x11, 7, CHAR_i, 0xFC, 0x11, 27, CHAR_j, 0xFC, 0x11, 6, CHAR_k, 0xFC, 0x11, 6, CHAR_l, 0xFC, 0x11, 7, CHAR_SPACE, 0xFC, 0x11, 26, CHAR_COMMA, EOS };
const u8 gText_NamingScreenKeyboard_mnopqrs[] = { 0xFC, 0x11, 11, CHAR_m, 0xFC, 0x11, 6, CHAR_n, 0xFC, 0x11, 7, CHAR_o, 0xFC, 0x11, 26, CHAR_p, 0xFC, 0x11, 6, CHAR_q, 0xFC, 0x11, 7, CHAR_r, 0xFC, 0x11, 6, CHAR_s, 0xFC, 0x11, 27, CHAR_SPACE, EOS };
const u8 gText_NamingScreenKeyboard_tuvwxyz[] = { 0xFC, 0x11, 12, CHAR_t, 0xFC, 0x11, 6, CHAR_u, 0xFC, 0x11, 6, CHAR_v, 0xFC, 0x11, 26, CHAR_w, 0xFC, 0x11, 6, CHAR_x, 0xFC, 0x11, 6, CHAR_y, 0xFC, 0x11, 6, CHAR_z, 0xFC, 0x11, 26, CHAR_SPACE, EOS };
const u8 gText_NamingScreenKeyboard_ABCDEF[] = { 0xFC, 0x11, 11, CHAR_A, 0xFC, 0x11, 6, CHAR_B, 0xFC, 0x11, 6, CHAR_C, 0xFC, 0x11, 26, CHAR_D, 0xFC, 0x11, 6, CHAR_E, 0xFC, 0x11, 6, CHAR_F, 0xFC, 0x11, 6, CHAR_SPACE, 0xFC, 0x11, 26, CHAR_PERIOD, EOS };
const u8 gText_NamingScreenKeyboard_GHIJKL[] = { 0xFC, 0x11, 11, CHAR_G, 0xFC, 0x11, 6, CHAR_H, 0xFC, 0x11, 6, CHAR_I, 0xFC, 0x11, 26, CHAR_J, 0xFC, 0x11, 6, CHAR_K, 0xFC, 0x11, 6, CHAR_L, 0xFC, 0x11, 6, CHAR_SPACE, 0xFC, 0x11, 26, CHAR_COMMA, EOS };
const u8 gText_NamingScreenKeyboard_MNOPQRS[] = { 0xFC, 0x11, 11, CHAR_M, 0xFC, 0x11, 6, CHAR_N, 0xFC, 0x11, 6, CHAR_O, 0xFC, 0x11, 26, CHAR_P, 0xFC, 0x11, 6, CHAR_Q, 0xFC, 0x11, 6, CHAR_R, 0xFC, 0x11, 6, CHAR_S, 0xFC, 0x11, 26, CHAR_SPACE, EOS };
const u8 gText_NamingScreenKeyboard_TUVWXYZ[] = { 0xFC, 0x11, 11, CHAR_T, 0xFC, 0x11, 6, CHAR_U, 0xFC, 0x11, 6, CHAR_V, 0xFC, 0x11, 26, CHAR_W, 0xFC, 0x11, 6, CHAR_X, 0xFC, 0x11, 6, CHAR_Y, 0xFC, 0x11, 6, CHAR_Z, 0xFC, 0x11, 26, CHAR_SPACE, EOS };
const u8 gText_NamingScreenKeyboard_01234[] = { 0xFC, 0x11, 11, CHAR_0, 0xFC, 0x11, 16, CHAR_1, 0xFC, 0x11, 16, CHAR_2, 0xFC, 0x11, 16, CHAR_3, 0xFC, 0x11, 16, CHAR_4, 0xFC, 0x11, 16, CHAR_SPACE, EOS };
const u8 gText_NamingScreenKeyboard_56789[] = { 0xFC, 0x11, 11, CHAR_5, 0xFC, 0x11, 16, CHAR_6, 0xFC, 0x11, 16, CHAR_7, 0xFC, 0x11, 16, CHAR_8, 0xFC, 0x11, 16, CHAR_9, 0xFC, 0x11, 16, CHAR_SPACE, EOS };
const u8 gText_NamingScreenKeyboard_Symbols1[] = { 0xFC, 0x11, 11, CHAR_EXCL_MARK, 0xFC, 0x11, 16, CHAR_QUESTION_MARK, 0xFC, 0x11, 16, CHAR_MALE, 0xFC, 0x11, 16, CHAR_FEMALE, 0xFC, 0x11, 16, CHAR_SLASH, 0xFC, 0x11, 16, CHAR_HYPHEN, EOS };
const u8 gText_NamingScreenKeyboard_Symbols2[] = { 0xFC, 0x11, 11, CHAR_ELLIPSIS, 0xFC, 0x11, 16, CHAR_DBL_QUOTE_LEFT, 0xFC, 0x11, 16, CHAR_DBL_QUOTE_RIGHT, 0xFC, 0x11, 18, CHAR_SGL_QUOTE_LEFT, 0xFC, 0x11, 18, CHAR_SGL_QUOTE_RIGHT, 0xFC, 0x11, 18, CHAR_SPACE, EOS };
#else
...
const u8 gText_EmptyTextInput1[] = { EOS };
const u8 gText_EmptyTextInput2[] = { EOS };
const u8 gText_EmptyTextInput3[] = { EOS };
const u8 gText_EmptyTextInput4[] = { EOS };
const u8 gText_EmptyTextInput5[] = { EOS };
const u8 gText_EmptyTextInput6[] = { EOS };
const u8 gText_EmptyTextInput7[] = { EOS };
const u8 gText_EmptyTextInput8[] = { EOS };
