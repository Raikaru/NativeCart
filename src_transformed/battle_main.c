...
const u8 gTypeEffectiveness[FIRERED_TYPE_EFFECTIVENESS_BYTE_COUNT] =
{
...
#ifdef PORTABLE
    TraceBattleMain("BattleMain: ResetHeap done");
#endif
    AllocateBattleResources();
#ifdef PORTABLE
    TraceBattleMain("BattleMain: AllocateBattleResources done");
#endif
    AllocateBattleSpritesData();
#ifdef PORTABLE
    TraceBattleMain("BattleMain: AllocateBattleSpritesData done");
#endif
    AllocateMonSpritesGfx();
#ifdef PORTABLE
    TraceBattleMain("BattleMain: AllocateMonSpritesGfx done");
#endif
...
#ifdef PORTABLE
    TraceBattleMain("BattleMain: CB2_InitBattleInternal enter");
#endif
...
#ifdef PORTABLE
    TraceBattleMain("BattleMain: VRAM clear done");
#endif
...
#ifdef PORTABLE
    TraceBattleMain("BattleMain: scanline setup done");
#endif
...
#ifdef PORTABLE
    TraceBattleMain("BattleMain: terrain=%u", gBattleTerrain);
#endif
...
static void CB2_HandleStartBattle(void)
{
...
#ifdef PORTABLE
    TraceBattleMain("BattleMain: CB2_HandleStartBattle state=%u", gBattleCommunication[MULTIUSE_STATE]);
#endif
    ...
    case 0:
        ...
        {
#ifdef PORTABLE
            TraceBattleMain("BattleMain: state0 ready");
#endif
            ShowBg(0);
            ShowBg(1);
            ShowBg(2);
    ...
    case 15:
#ifdef PORTABLE
        TraceBattleMain("BattleMain: state15 init controllers");
#endif
    ...
    case 16:
#ifdef PORTABLE
        TraceBattleMain("BattleMain: state16 sprite init s1=%u s2=%u", gBattleCommunication[SPRITES_INIT_STATE1], gBattleCommunication[SPRITES_INIT_STATE2]);
        TraceBattleMain("BattleMain: state16 pre-BattleInitAllSprites");
#endif
        {
            bool8 spritesReady = BattleInitAllSprites(&gBattleCommunication[SPRITES_INIT_STATE1], &gBattleCommunication[SPRITES_INIT_STATE2]);
#ifdef PORTABLE
            TraceBattleMain("BattleMain: state16 post-BattleInitAllSprites ready=%u s1=%u s2=%u", spritesReady, gBattleCommunication[SPRITES_INIT_STATE1], gBattleCommunication[SPRITES_INIT_STATE2]);
#endif
            if (spritesReady)
            {
#ifdef PORTABLE
                TraceBattleMain("BattleMain: state16 BattleInitAllSprites returned true");
                TraceBattleMain("BattleMain: state16 pre-callback handoff cb1=%p preBattle=%p", gMain.callback1, gPreBattleCallback1);
#endif
                gPreBattleCallback1 = gMain.callback1;
                gMain.callback1 = BattleMainCB1;
#ifdef PORTABLE
                TraceBattleMain("BattleMain: state16 post-callback1 swap cb1=%p preBattle=%p", gMain.callback1, gPreBattleCallback1);
                TraceBattleMain("BattleMain: state16 pre-callback2 swap cb2=%p", gMain.callback2);
#endif
                #ifdef PORTABLE
                gMain.callback2 = BattleMainCB2;
                gMain.state = 0;
                TraceBattleMain("BattleMain: state16 post-callback2 swap cb2=%p state=%u", gMain.callback2, gMain.state);
                #else
                SetMainCallback2(BattleMainCB2);
                #endif
#ifdef PORTABLE
                TraceBattleMain("BattleMain: switched to BattleMainCB2");
#endif
                if (gBattleTypeFlags & BATTLE_TYPE_LINK)
                {
                    gBattleTypeFlags |= BATTLE_TYPE_LINK_IN_BATTLE;
#ifdef PORTABLE
                    TraceBattleMain("BattleMain: state16 set LINK_IN_BATTLE");
#endif
                }
            }
        }
...
static void CB2_HandleStartMultiBattle(void)
{
    ...
    case 12:
        if (BattleInitAllSprites(&gBattleCommunication[SPRITES_INIT_STATE1], &gBattleCommunication[SPRITES_INIT_STATE2]))
        {
            ...
            gMain.callback2 = BattleMainCB2;
            gMain.state = 0;
            TraceBattleMain("BattleMain: case12 switched to BattleMainCB2");
#else
            SetMainCallback2(BattleMainCB2);
#endif
            if (gBattleTypeFlags & BATTLE_TYPE_LINK)
...
void VBlankCB_Battle(void)
{
...
#ifdef PORTABLE
    TraceBattleMain("BattleMain: VBlankCB_Battle pre-LoadOam");
#endif
    LoadOam();
#ifdef PORTABLE
    TraceBattleMain("BattleMain: VBlankCB_Battle post-LoadOam");
    TraceBattleMain("BattleMain: VBlankCB_Battle pre-ProcessSpriteCopyRequests");
#endif
    ...
    TransferPlttBuffer();
#ifdef PORTABLE
    TraceBattleMain("BattleMain: VBlankCB_Battle post-TransferPlttBuffer");
    TraceBattleMain("BattleMain: VBlankCB_Battle pre-ScanlineEffect");
#endif
    ScanlineEffect_InitHBlankDmaTransfer();
#ifdef PORTABLE
    TraceBattleMain("BattleMain: VBlankCB_Battle post-ScanlineEffect");
#endif
}
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: GetMonsData state=%u battler=%u exec=%u", gBattleCommunication[MULTIUSE_STATE], gBattleCommunication[1], gBattleControllerExecFlags);
#endif
    switch (gBattleCommunication[MULTIUSE_STATE])
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: PrepareBackgroundSlide exec=%u terrain=%u", gBattleControllerExecFlags, gBattleTerrain);
#endif
    if (gBattleControllerExecFlags == 0)
    {
...
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: DrawTrainersOrMonsSprites exec=%u battlers=%u", gBattleControllerExecFlags, gBattlersCount);
#endif
...
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: DrawPartySummaryScreens exec=%u trainer=%u", gBattleControllerExecFlags, (gBattleTypeFlags & BATTLE_TYPE_TRAINER) != 0);
#endif
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: PrintTrainerWantsToBattle exec=%u", gBattleControllerExecFlags);
#endif
    if (gBattleControllerExecFlags == 0)
    {
        gActiveBattler = GetBattlerAtPosition(B_POSITION_OPPONENT_LEFT);
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: PrintWildMonAttacked exec=%u", gBattleControllerExecFlags);
#endif
    if (gBattleControllerExecFlags == 0)
    {
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: PrintOpponentSendsOut exec=%u", gBattleControllerExecFlags);
#endif
    if (gBattleControllerExecFlags == 0)
    {
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: OpponentSendsOutMonAnimation exec=%u", gBattleControllerExecFlags);
#endif
    if (gBattleControllerExecFlags == 0)
    {
        for (gActiveBattler = 0; gActiveBattler < gBattlersCount; gActiveBattler++)
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: RecordMonsToDex exec=%u", gBattleControllerExecFlags);
#endif
    if (gBattleControllerExecFlags == 0)
    {
        for (gActiveBattler = 0; gActiveBattler < gBattlersCount; gActiveBattler++)
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: PrintPlayerSendsOut exec=%u", gBattleControllerExecFlags);
#endif
    if (gBattleControllerExecFlags == 0)
    {
        if (!(gBattleTypeFlags & BATTLE_TYPE_SAFARI))
...
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: PlayerSendsOutMonAnimation exec=%u", gBattleControllerExecFlags);
#endif
...
{
#ifdef PORTABLE
    TraceBattleMain("BattleIntro: SwitchInPlayerMons exec=%u", gBattleControllerExecFlags);
#endif
    if (gBattleControllerExecFlags == 0)
    {
        for (gActiveBattler = 0; gActiveBattler < gBattlersCount; gActiveBattler++)
...
void SwapTurnOrder(u8 id1, u8 id2)
{
    ...
    GBA_SWAP(gActionsByTurnOrder[id1], gActionsByTurnOrder[id2], temp);
    GBA_SWAP(gBattlerByTurnOrder[id1], gBattlerByTurnOrder[id2], temp);
}
