...
#ifdef PORTABLE
#include "text_window_graphics_portable_assets.h"
#define sUserFrame_Type1_Gfx sUserFrame_Type1_Gfx_Portable
#define sUserFrame_Type2_Gfx sUserFrame_Type2_Gfx_Portable
#define sUserFrame_Type3_Gfx sUserFrame_Type3_Gfx_Portable
#define sUserFrame_Type4_Gfx sUserFrame_Type4_Gfx_Portable
#define sUserFrame_Type5_Gfx sUserFrame_Type5_Gfx_Portable
#define sUserFrame_Type6_Gfx sUserFrame_Type6_Gfx_Portable
#define sUserFrame_Type7_Gfx sUserFrame_Type7_Gfx_Portable
#define sUserFrame_Type8_Gfx sUserFrame_Type8_Gfx_Portable
#define sUserFrame_Type9_Gfx sUserFrame_Type9_Gfx_Portable
#define sUserFrame_Type10_Gfx sUserFrame_Type10_Gfx_Portable
#define sUserFrame_Type1_Pal sUserFrame_Type1_Pal_Portable
#define sUserFrame_Type2_Pal sUserFrame_Type2_Pal_Portable
#define sUserFrame_Type3_Pal sUserFrame_Type3_Pal_Portable
#define sUserFrame_Type4_Pal sUserFrame_Type4_Pal_Portable
#define sUserFrame_Type5_Pal sUserFrame_Type5_Pal_Portable
#define sUserFrame_Type6_Pal sUserFrame_Type6_Pal_Portable
#define sUserFrame_Type7_Pal sUserFrame_Type7_Pal_Portable
#define sUserFrame_Type8_Pal sUserFrame_Type8_Pal_Portable
#define sUserFrame_Type9_Pal sUserFrame_Type9_Pal_Portable
#define sUserFrame_Type10_Pal sUserFrame_Type10_Pal_Portable
#else
