...
#include <stdio.h>
#include <string.h>
#include "naming_screen_portable_assets.h"
#define gNamingScreenKeyboard_Pal gNamingScreenKeyboard_Pal_Portable
#define gNamingScreenRival_Pal gNamingScreenRival_Pal_Portable
#define gNamingScreenMenu_Pal gNamingScreenMenu_Pal_Portable
#define gNamingScreenMenu_Gfx gNamingScreenMenu_Gfx_Portable
#define gNamingScreenBackground_Tilemap gNamingScreenBackground_Tilemap_Portable
#define gNamingScreenKeyboardUpper_Tilemap gNamingScreenKeyboardUpper_Tilemap_Portable
#define gNamingScreenKeyboardLower_Tilemap gNamingScreenKeyboardLower_Tilemap_Portable
#define gNamingScreenKeyboardSymbols_Tilemap gNamingScreenKeyboardSymbols_Tilemap_Portable
#define gNamingScreenPageSwapFrame_Gfx gNamingScreenPageSwapFrame_Gfx_Portable
#define gNamingScreenBackButton_Gfx gNamingScreenBackButton_Gfx_Portable
#define gNamingScreenOKButton_Gfx gNamingScreenOKButton_Gfx_Portable
#define gNamingScreenPageSwapUpper_Gfx gNamingScreenPageSwapUpper_Gfx_Portable
#define gNamingScreenPageSwapLower_Gfx gNamingScreenPageSwapLower_Gfx_Portable
#define gNamingScreenPageSwapOthers_Gfx gNamingScreenPageSwapOthers_Gfx_Portable
#define gNamingScreenCursor_Gfx gNamingScreenCursor_Gfx_Portable
#define gNamingScreenCursorSquished_Gfx gNamingScreenCursorSquished_Gfx_Portable
#define gNamingScreenCursorFilled_Gfx gNamingScreenCursorFilled_Gfx_Portable
#define gNamingScreenPageSwapButton_Gfx gNamingScreenPageSwapButton_Gfx_Portable
#define gNamingScreenInputArrow_Gfx gNamingScreenInputArrow_Gfx_Portable
#define gNamingScreenUnderscore_Gfx gNamingScreenUnderscore_Gfx_Portable
#define sPCIconOff_Gfx sPCIconOff_Gfx_Portable
#define sPCIconOn_Gfx sPCIconOn_Gfx_Portable
#define sRival_Gfx sRival_Gfx_Portable
...
#ifndef PORTABLE
#define sPCIconOff_Gfx ((const u16 *)NULL)
#define sPCIconOn_Gfx ((const u16 *)NULL)
#define sRival_Gfx ((const u16 *)NULL)
#endif
...
static const u8 sKeyboardChars[KBPAGE_COUNT][KBROW_COUNT][KBCOL_COUNT] = {
    [KEYBOARD_LETTERS_LOWER] = {
        { CHAR_a, CHAR_b, CHAR_c, CHAR_d, CHAR_e, CHAR_f, CHAR_SPACE, CHAR_PERIOD },
        { CHAR_g, CHAR_h, CHAR_i, CHAR_j, CHAR_k, CHAR_l, CHAR_SPACE, CHAR_COMMA },
        { CHAR_m, CHAR_n, CHAR_o, CHAR_p, CHAR_q, CHAR_r, CHAR_s, EOS },
        { CHAR_t, CHAR_u, CHAR_v, CHAR_w, CHAR_x, CHAR_y, CHAR_z, EOS },
    },
    [KEYBOARD_LETTERS_UPPER] = {
        { CHAR_A, CHAR_B, CHAR_C, CHAR_D, CHAR_E, CHAR_F, CHAR_SPACE, CHAR_PERIOD },
        { CHAR_G, CHAR_H, CHAR_I, CHAR_J, CHAR_K, CHAR_L, CHAR_SPACE, CHAR_COMMA },
    ...
    [KEYBOARD_SYMBOLS] = {
        { CHAR_0, CHAR_1, CHAR_2, CHAR_3, CHAR_4, EOS, EOS, EOS },
        { CHAR_5, CHAR_6, CHAR_7, CHAR_8, CHAR_9, EOS, EOS, EOS },
        { CHAR_EXCL_MARK, CHAR_QUESTION_MARK, CHAR_MALE, CHAR_FEMALE, CHAR_SLASH, CHAR_HYPHEN, EOS, EOS },
        { CHAR_ELLIPSIS, CHAR_DBL_QUOTE_LEFT, CHAR_DBL_QUOTE_RIGHT, CHAR_SGL_QUOTE_LEFT, CHAR_SGL_QUOTE_RIGHT, EOS, EOS, EOS },
    }
};
#else
static const u8 sKeyboardChars[KBPAGE_COUNT][KBROW_COUNT][KBCOL_COUNT] = {
...
#ifdef PORTABLE
    TraceNamingScreen("InitBGs regs set");
#endif
...
{
#ifdef PORTABLE
    TraceNamingScreen("CreateNamingScreenTask enter");
#endif
...
#ifdef PORTABLE
    TraceNamingScreen("CreateNamingScreenTask exit");
#endif
}
...
{
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-bg3");
#endif
    DecompressToBgTilemapBuffer(3, gNamingScreenBackground_Tilemap);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-bg3");
#endif
    sNamingScreen->currentPage = KBPAGE_LETTERS_UPPER;
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-bg2");
#endif
    DecompressToBgTilemapBuffer(2, gNamingScreenKeyboardLower_Tilemap);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-bg2");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-bg1");
#endif
    DecompressToBgTilemapBuffer(1, gNamingScreenKeyboardUpper_Tilemap);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-bg1");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-print2");
#endif
    PrintKeyboardKeys(sNamingScreen->windows[WIN_KB_PAGE_2], KEYBOARD_LETTERS_LOWER);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-print2");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-print1");
#endif
    PrintKeyboardKeys(sNamingScreen->windows[WIN_KB_PAGE_1], KEYBOARD_LETTERS_UPPER);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-print1");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-draw-entry");
#endif
    DrawTextEntry();
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-draw-entry");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-entry-box");
#endif
    DrawTextEntryBox();
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-entry-box");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-controls");
#endif
    PrintControls();
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-controls");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-copy1");
#endif
    CopyBgTilemapBufferToVram(1);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-copy1");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-copy2");
#endif
    CopyBgTilemapBufferToVram(2);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-copy2");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-copy3");
#endif
    CopyBgTilemapBufferToVram(3);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-copy3");
#endif
#ifdef PORTABLE
    TraceNamingScreen("FadeIn pre-blend");
#endif
    BlendPalettes(PALETTES_ALL, 16, RGB_BLACK);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-blend");
    TraceNamingScreen("FadeIn pre-fade");
#endif
    BeginNormalPaletteFade(PALETTES_ALL, 0, 16, 0, RGB_BLACK);
#ifdef PORTABLE
    TraceNamingScreen("FadeIn post-fade");
#endif
    sNamingScreen->state++;
    return FALSE;
}
...
{
#ifdef PORTABLE
    TraceNamingScreen("MainState_PressedOKButton enter");
#endif
    SaveInputText();
    ...
    {
#ifdef PORTABLE
        TraceNamingScreen("MainState_PressedOKButton -> fade out");
#endif
...
{
#ifdef PORTABLE
    TraceNamingScreen("MainState_FadeOut begin fade");
#endif
...
static bool8 MainState_Exit(void)
{
    ...
    {
#ifdef PORTABLE
        TraceNamingScreen("MainState_Exit pre-return-callback");
#endif
        ...
        RestoreHelpContext();
#ifdef PORTABLE
        TraceNamingScreen("MainState_Exit cleanup-done");
#endif
    }
    return FALSE;
}
...
static bool8 PageSwapAnimState_1(struct Task *task)
{
    ...
    *vOffsets[sNamingScreen->bgToHide] = Sin((task->tFrameCount + 128) & 0xFF, 40);
    ...
    {
        u8 temp;
        GBA_SWAP(sNamingScreen->bg1Priority, sNamingScreen->bg2Priority, temp);
        task->tState++;
    }
    return 0;
}
...
static bool8 PageSwapAnimState_2(struct Task *task)
{
    ...
    *vOffsets[sNamingScreen->bgToHide] = Sin((task->tFrameCount + 128) & 0xFF, 40);
    ...
    {
        u8 temp;
        GBA_SWAP(sNamingScreen->bgToReveal, sNamingScreen->bgToHide, temp);
        task->tState++;
    }
    return 0;
}
...
{
#ifdef PORTABLE
    TraceNamingScreen("CreateSprites enter");
#endif
    CreateCursorSprite();
...
#ifdef PORTABLE
    TraceNamingScreen("CreateSprites exit");
#endif
}
...
#ifdef PORTABLE
    char buffer[96];
    snprintf(buffer, sizeof(buffer), "NamingScreen: CreatePlayerIcon gfx=%u", rivalGfxId);
    firered_runtime_trace_external(buffer);
#endif
...
#ifdef PORTABLE
    TraceNamingScreen("CreateRivalIcon");
#endif
...
static void DrawMonTextEntryBox(void)
{
    ...
    if (TraceNamingScreenEnvEnabled())
    {
        ...
        snprintf(trace, sizeof(trace),
                 "NamingScreen: title bytes %u %u %u %u %u %u %u %u %u %u %u %u",
                 buffer[0], buffer[1], buffer[2], buffer[3], buffer[4], buffer[5],
                 buffer[6], buffer[7], buffer[8], buffer[9], buffer[10], buffer[11]);
        firered_runtime_trace_external(trace);
    }
    TraceNamingScreen("DrawMonTextEntryBox pre-fill");
#else
    ...
    FillWindowPixelBuffer(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], PIXEL_FILL(1));
#ifdef PORTABLE
    TraceNamingScreen("DrawMonTextEntryBox post-fill");
    TraceNamingScreen("DrawMonTextEntryBox pre-print");
#endif
    AddTextPrinterParameterized(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], FONT_NORMAL_COPY_1, buffer, 1, 1, 0, NULL);
#ifdef PORTABLE
    TraceNamingScreen("DrawMonTextEntryBox post-print");
    TraceNamingScreen("DrawMonTextEntryBox pre-tilemap");
#endif
    PutWindowTilemap(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX]);
#ifdef PORTABLE
    TraceNamingScreen("DrawMonTextEntryBox post-tilemap");
#endif
}
...
{
#ifdef PORTABLE
    TraceNamingScreen("LoadGfx enter");
#endif
...
#ifdef PORTABLE
    TraceNamingScreen("LoadGfx exit");
#endif
}
...
{
#ifdef PORTABLE
    TraceNamingScreen("CreateHelperTasks enter");
#endif
    CreateInputHandlerTask();
    CreateButtonFlashTask();
#ifdef PORTABLE
    TraceNamingScreen("CreateHelperTasks exit");
#endif
}
...
{
#ifdef PORTABLE
    TraceNamingScreen("LoadPalettes enter");
#endif
...
#ifdef PORTABLE
    TraceNamingScreen("LoadPalettes exit");
#endif
}
...
static void DrawTextEntry(void)
{
...
#ifdef PORTABLE
    TraceNamingScreen("DrawTextEntry pre-fill");
#endif
    FillWindowPixelBuffer(sNamingScreen->windows[WIN_TEXT_ENTRY], PIXEL_FILL(1));
#ifdef PORTABLE
    TraceNamingScreen("DrawTextEntry post-fill");
#endif
    ...
    for (i = 0; i < maxChars; i++)
    {
        ...
        {
            char buffer[128];
            snprintf(buffer, sizeof(buffer), "NamingScreen: DrawTextEntry pre-char i=%u ch=%u x=%u", i, temp[0], i * 8 + xpos + extraWidth);
            firered_runtime_trace_external(buffer);
        }
#endif
...
#ifdef PORTABLE
    TraceNamingScreen("DrawTextEntry pre-gender");
#endif
    TryDrawGenderIcon();
#ifdef PORTABLE
    TraceNamingScreen("DrawTextEntry post-gender");
    TraceNamingScreen("DrawTextEntry pre-copy");
#endif
    CopyWindowToVram(sNamingScreen->windows[WIN_TEXT_ENTRY], COPYWIN_GFX);
#ifdef PORTABLE
    TraceNamingScreen("DrawTextEntry post-copy");
    TraceNamingScreen("DrawTextEntry pre-tilemap");
#endif
    PutWindowTilemap(sNamingScreen->windows[WIN_TEXT_ENTRY]);
#ifdef PORTABLE
    TraceNamingScreen("DrawTextEntry post-tilemap");
#endif
}
...
{
#ifdef PORTABLE
    static u8 sNamingScreenCbTraceCount;
    if (sNamingScreen && sNamingScreenCbTraceCount < 8)
    {
        char buffer[96];
        snprintf(buffer, sizeof(buffer), "NamingScreen: CB2_NamingScreen state=%u", sNamingScreen->state);
        firered_runtime_trace_external(buffer);
        sNamingScreenCbTraceCount++;
    }
#endif
    RunTasks();
#ifdef PORTABLE
