...
{
    return ResolveRomPointer(script);
}
#endif
...
static void LoadSaveblockObjEventScripts(void)
{
    ...
    if (src == NULL || objectEventCount == 0)
        return;
...
static void LoadMapFromWarp(bool32 unused)
{
...
#ifdef PORTABLE
    firered_runtime_trace_external("LoadMapFromWarp: start");
#endif
    LoadCurrentMapData();
    LoadObjEventTemplatesFromHeader();
    ...
    RunOnTransitionMapScript();
#ifdef PORTABLE
    firered_runtime_trace_external("LoadMapFromWarp: post-transition-script");
#endif
    TryRegenerateRenewableHiddenItems();
    UpdateLocationHistoryForRoamer();
    RoamerMoveToOtherLocationSet();
    ...
    InitMap();
#ifdef PORTABLE
    firered_runtime_trace_external("LoadMapFromWarp: exit");
#endif
}
...
{
#ifdef PORTABLE
    firered_runtime_trace_external("InitOverworldBgs: start");
#endif
    ...
    InitFieldMessageBox();
#ifdef PORTABLE
    firered_runtime_trace_external("InitOverworldBgs: exit");
#endif
}
...
#ifdef PORTABLE
    static bool8 sLoggedDoCb1Enter;
    static bool8 sLoggedAfterPlayerAvatar;
    static bool8 sLoggedAfterInput;
    static bool8 sLoggedBeforeProcessInput;
    static bool8 sLoggedBeforePlayerStep;
    static bool8 sLoggedBeforeQuestLogCb;

    if (!sLoggedDoCb1Enter)
    {
        firered_runtime_trace_external("DoCB1_Overworld: enter");
        sLoggedDoCb1Enter = TRUE;
    }
#endif
...
#ifdef PORTABLE
    if (!sLoggedAfterPlayerAvatar)
    {
        firered_runtime_trace_external("DoCB1_Overworld: post-UpdatePlayerAvatarTransitionState");
        sLoggedAfterPlayerAvatar = TRUE;
    }
#endif
...
#ifdef PORTABLE
    if (!sLoggedAfterInput)
    {
        firered_runtime_trace_external("DoCB1_Overworld: post-FieldInput_HandleCancelSignpost");
        sLoggedAfterInput = TRUE;
    }
#endif
    if (!ArePlayerFieldControlsLocked())
    {
#ifdef PORTABLE
        if (!sLoggedBeforeProcessInput)
        {
            firered_runtime_trace_external("DoCB1_Overworld: pre-ProcessPlayerFieldInput");
            sLoggedBeforeProcessInput = TRUE;
        }
#endif
        ...
        {
#ifdef PORTABLE
            if (!sLoggedBeforePlayerStep)
            {
                firered_runtime_trace_external("DoCB1_Overworld: pre-player_step");
                sLoggedBeforePlayerStep = TRUE;
            }
#endif
...
#ifdef PORTABLE
    if (!sLoggedBeforeQuestLogCb)
    {
        firered_runtime_trace_external("DoCB1_Overworld: pre-RunQuestLogCB");
        sLoggedBeforeQuestLogCb = TRUE;
    }
#endif
    RunQuestLogCB();
}
...
{
#ifdef PORTABLE
    static bool8 sLoggedCb1Overworld;

    if (!sLoggedCb1Overworld)
    {
        sLoggedCb1Overworld = TRUE;
        firered_runtime_trace_external("CB1_Overworld: enter");
    }
#endif
...
#ifdef PORTABLE
MainCallback firered_portable_get_cb2_overworld(void)
{
    return CB2_Overworld;
}

MainCallback firered_portable_get_cb2_overworld_basic(void)
{
    return CB2_OverworldBasic;
}
#endif
...
{
#ifdef PORTABLE
    static bool8 sLoggedNewGame;

    if (!sLoggedNewGame)
    {
        sLoggedNewGame = TRUE;
        firered_runtime_trace_external("CB2_NewGame: enter");
    }
    firered_runtime_trace_external("CB2_NewGame: pre-FieldClearVBlankHBlankCallbacks");
#endif
    FieldClearVBlankHBlankCallbacks();
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-FieldClearVBlankHBlankCallbacks");
    firered_runtime_trace_external("CB2_NewGame: pre-StopMapMusic");
#endif
    StopMapMusic();
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-StopMapMusic");
    firered_runtime_trace_external("CB2_NewGame: pre-ResetSafariZoneFlag_");
#endif
    ResetSafariZoneFlag_();
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-ResetSafariZoneFlag_");
    firered_runtime_trace_external("CB2_NewGame: pre-NewGameInitData");
#endif
    NewGameInitData();
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-NewGameInitData");
    firered_runtime_trace_external("CB2_NewGame: pre-ResetInitialPlayerAvatarState");
#endif
    ResetInitialPlayerAvatarState();
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-ResetInitialPlayerAvatarState");
    firered_runtime_trace_external("CB2_NewGame: pre-PlayTimeCounter_Start");
#endif
    PlayTimeCounter_Start();
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-PlayTimeCounter_Start");
    firered_runtime_trace_external("CB2_NewGame: pre-ScriptContext_Init");
#endif
    ScriptContext_Init();
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-ScriptContext_Init");
    firered_runtime_trace_external("CB2_NewGame: pre-UnlockPlayerFieldControls");
#endif
    UnlockPlayerFieldControls();
    gFieldCallback = FieldCB_WarpExitFadeFromBlack;
    gFieldCallback2 = NULL;
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: pre-DoMapLoadLoop");
#endif
    DoMapLoadLoop(&gMain.state);
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-DoMapLoadLoop");
    firered_runtime_trace_external("CB2_NewGame: pre-SetFieldVBlankCallback");
#endif
    SetFieldVBlankCallback();
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-SetFieldVBlankCallback");
    firered_runtime_trace_external("CB2_NewGame: pre-SetMainCallback1");
#endif
    SetNotInSaveFailedScreen();
    SetMainCallback1(CB1_Overworld);
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: post-SetMainCallback1");
    firered_runtime_trace_external("CB2_NewGame: pre-SetMainCallback2");
#endif
    SetMainCallback2(CB2_Overworld);
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_NewGame: exit");
#endif
}
...
static void SetReturnToOverworldMainCallback(void)
{
    SetMainCallback2(CB2_Overworld);
}
...
static void CB2_LoadMapOnReturnToFieldCableClub(void)
{
    if (LoadMapInStepsLink(&gMain.state))
    {
        ...
        SetReturnToOverworldMainCallback();
    }
}
...
static bool32 LoadMapInStepsLocal(u8 *state, bool32 inLink)
{
    ...
    case 0:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case0");
#endif
        InitOverworldBgs();
#ifdef PORTABLE
        FieldClearVBlankHBlankCallbacks();
    ...
    case 1:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case1");
#endif
    ...
    case 2:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case2");
#endif
        ResumeMap(inLink);
        (*state)++;
        break;
    case 3:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case3");
#endif
        if (QuestLog_ShouldEndSceneOnMapChange() == TRUE)
            return TRUE;
        (*state)++;
    ...
    case 4:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case4");
#endif
    ...
    case 5:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case5");
#endif
        InitCurrentFlashLevelScanlineEffect();
        InitOverworldGraphicsRegisters();
        (*state)++;
    ...
    case 6:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case6");
#endif
        move_tilemap_camera_to_upper_left_corner();
        (*state)++;
        break;
    case 7:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case7");
#endif
        CopyPrimaryTilesetToVram(gMapHeader.mapLayout);
        (*state)++;
        break;
    case 8:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case8");
#endif
        CopySecondaryTilesetToVram(gMapHeader.mapLayout);
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case8 post-copy");
#endif
        (*state)++;
        break;
    case 9:
    {
        bool8 waiting = FreeTempTileDataBuffersIfPossible();
#ifdef PORTABLE
        static bool8 sCase9LoggedWait;

        if (waiting == TRUE)
        {
            if (!sCase9LoggedWait)
            {
                firered_runtime_trace_external("LoadMapInStepsLocal: case9 waiting=1");
                sCase9LoggedWait = TRUE;
            }
        }
        else
        {
            sCase9LoggedWait = FALSE;
            firered_runtime_trace_external("LoadMapInStepsLocal: case9 waiting=0");
            LoadMapTilesetPalettes(gMapHeader.mapLayout);
            (*state)++;
        }
#else
    ...
    case 10:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case10");
#endif
        DrawWholeMapView();
        (*state)++;
        break;
    case 11:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case11");
#endif
        InitTilesetAnimations();
        (*state)++;
        break;
    case 12:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case12 enter");
#endif
        ...
        {
#ifdef PORTABLE
            firered_runtime_trace_external("LoadMapInStepsLocal: case12 show-map-name");
#endif
            ShowMapNamePopup(FALSE);
        }
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case12 exit");
#endif
        (*state)++;
        break;
    case 13:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case13 enter");
#endif
        if (RunFieldCallback())
        {
#ifdef PORTABLE
            firered_runtime_trace_external("LoadMapInStepsLocal: case13 done");
#endif
            (*state)++;
        }
        break;
    case 14:
#ifdef PORTABLE
        firered_runtime_trace_external("LoadMapInStepsLocal: case14 enter");
#endif
        return TRUE;
    }
    return FALSE;
...
static bool32 ReturnToFieldLocal(u8 *state)
{
    ...
    case 0:
#ifdef PORTABLE
        firered_runtime_trace_external("Overworld: ReturnToFieldLocal case0");
#endif
        InitOverworldBgs();
        QuestLog_InitPalettesBackup();
        ResumeMap(FALSE);
    ...
    case 1:
#ifdef PORTABLE
        firered_runtime_trace_external("Overworld: ReturnToFieldLocal case1");
#endif
        (*state)++;
        break;
    case 2:
#ifdef PORTABLE
        firered_runtime_trace_external("Overworld: ReturnToFieldLocal case2");
#endif
        InitViewGraphics();
        SetHelpContextForMap();
        (*state)++;
    ...
    case 3:
#ifdef PORTABLE
        firered_runtime_trace_external("Overworld: ReturnToFieldLocal case3");
#endif
        if (RunFieldCallback())
            (*state)++;
        break;
    case 4:
#ifdef PORTABLE
        firered_runtime_trace_external("Overworld: ReturnToFieldLocal case4");
#endif
        return TRUE;
    }
    return FALSE;
