...
#ifdef PORTABLE
#include "party_menu_portable_assets.h"
#define gPartyMenuBg_Gfx gPartyMenuBg_Gfx_Portable
#define gPartyMenuBg_Pal gPartyMenuBg_Pal_Portable
#define gPartyMenuBg_Tilemap gPartyMenuBg_Tilemap_Portable
#define gPartyMenuPokeball_Gfx gPartyMenuPokeball_Gfx_Portable
#define gPartyMenuPokeballSmall_Gfx gPartyMenuPokeballSmall_Gfx_Portable
#define gPartyMenuPokeball_Pal gPartyMenuPokeball_Pal_Portable
#endif
...
static void DisplayPartyPokemonLevel(u8 level, struct PartyMenuBox *menuBox)
{
    ...
    StringExpandPlaceholders(gStringVar1, gText_Lv);
