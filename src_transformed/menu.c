...
#ifdef PORTABLE
    firered_runtime_trace_external("CreateTopBarWindowLoadPalette: post-AddWindow");
#endif
    if (palette > 15)
...
void TopBarWindowPrintTwoStrings(const u8 *string, const u8 *string2, bool8 fgColorChooser, u8 unused, bool8 copyToVram)
{
    ...
    {
#ifdef PORTABLE
        firered_runtime_trace_external("TopBarWindowPrintTwoStrings: enter");
#endif
        if (fgColorChooser)
        {
            color[0] = 0;
...
#ifdef PORTABLE
        firered_runtime_trace_external("TopBarWindowPrintTwoStrings: pre-PutWindowTilemap");
#endif
        PutWindowTilemap(sTopBarWindowId);
#ifdef PORTABLE
        firered_runtime_trace_external("TopBarWindowPrintTwoStrings: post-PutWindowTilemap");
        firered_runtime_trace_external("TopBarWindowPrintTwoStrings: pre-FillWindowPixelBuffer");
#endif
        FillWindowPixelBuffer(sTopBarWindowId, PIXEL_FILL(15));
#ifdef PORTABLE
        firered_runtime_trace_external("TopBarWindowPrintTwoStrings: post-FillWindowPixelBuffer");
#endif
        if (string2)
        {
#ifdef PORTABLE
            firered_runtime_trace_external("TopBarWindowPrintTwoStrings: pre-GetStringWidth");
#endif
            width = GetStringWidth(FONT_SMALL, string2, 0);
#ifdef PORTABLE
            firered_runtime_trace_external("TopBarWindowPrintTwoStrings: post-GetStringWidth");
            firered_runtime_trace_external("TopBarWindowPrintTwoStrings: pre-AddTextPrinterParameterized3");
#endif
            AddTextPrinterParameterized3(sTopBarWindowId, FONT_SMALL, -20 - width, 1, color, 0, string2);
#ifdef PORTABLE
            firered_runtime_trace_external("TopBarWindowPrintTwoStrings: post-AddTextPrinterParameterized3");
#endif
        }
#ifdef PORTABLE
        firered_runtime_trace_external("TopBarWindowPrintTwoStrings: pre-AddTextPrinterParameterized4");
#endif
        AddTextPrinterParameterized4(sTopBarWindowId, FONT_NORMAL_COPY_1, 4, 1, 0, 0, color, 0, string);
#ifdef PORTABLE
        firered_runtime_trace_external("TopBarWindowPrintTwoStrings: post-AddTextPrinterParameterized4");
#endif
        if (copyToVram)
#ifdef PORTABLE
        {
            firered_runtime_trace_external("TopBarWindowPrintTwoStrings: pre-CopyWindowToVram");
#endif
            CopyWindowToVram(sTopBarWindowId, COPYWIN_FULL);
#ifdef PORTABLE
            firered_runtime_trace_external("TopBarWindowPrintTwoStrings: post-CopyWindowToVram");
        }
#endif
    }
}
