...
#ifdef PORTABLE
#include <stdio.h>
#include "intro_portable_copyright_assets.h"
extern void firered_runtime_trace_external(const char *message);
extern void firered_runtime_trace_bytes_external(const char *label, const void *src, const void *dst);
#endif
...
#ifdef PORTABLE
static void TraceIntroSequenceState(const char *name, struct IntroSequenceData *seq)
{
    (void)name;
    (void)seq;
}
...
#ifdef PORTABLE
#define sCopyright_Pal sCopyright_Pal_Portable
#define sCopyright_Gfx sCopyright_Gfx_Portable
#define sCopyright_Map sCopyright_Map_Portable
#define sGameFreakBg_Pal sGameFreakBg_Pal_Portable
#define sGameFreakBg_Gfx sGameFreakBg_Gfx_Portable
#define sGameFreakBg_Map sGameFreakBg_Map_Portable
#define sGameFreakLogo_Pal sGameFreakLogo_Pal_Portable
#define sGameFreakText_Gfx sGameFreakText_Gfx_Portable
#define sGameFreakLogo_Gfx sGameFreakLogo_Gfx_Portable
#define sStar_Pal sStar_Pal_Portable
#define sStar_Gfx sStar_Gfx_Portable
#define sSparkles_Pal sSparkles_Pal_Portable
#define sSparklesSmall_Gfx sSparklesSmall_Gfx_Portable
#define sSparklesBig_Gfx sSparklesBig_Gfx_Portable
#define sPresents_Gfx sPresents_Gfx_Portable
#define sScene1_Grass_Pal sScene1_Grass_Pal_Portable
#define sScene1_Grass_Gfx sScene1_Grass_Gfx_Portable
#define sScene1_Grass_Map sScene1_Grass_Map_Portable
#define sScene1_Bg_Pal sScene1_Bg_Pal_Portable
#define sScene1_Bg_Gfx sScene1_Bg_Gfx_Portable
#define sScene1_Bg_Map sScene1_Bg_Map_Portable
#define sScene2_Bg_Pal sScene2_Bg_Pal_Portable
#define sScene2_Bg_Gfx sScene2_Bg_Gfx_Portable
#define sScene2_Bg_Map sScene2_Bg_Map_Portable
#define sScene2_Plants_Pal sScene2_Plants_Pal_Portable
#define sScene2_Plants_Gfx sScene2_Plants_Gfx_Portable
#define sScene2_Plants_Map sScene2_Plants_Map_Portable
#define sGengar_Pal sGengar_Pal_Portable
#define sScene2_GengarClose_Gfx sScene2_GengarClose_Gfx_Portable
#define sScene2_GengarClose_Map sScene2_GengarClose_Map_Portable
#define sScene2_NidorinoClose_Pal sScene2_NidorinoClose_Pal_Portable
#define sScene2_NidorinoClose_Gfx sScene2_NidorinoClose_Gfx_Portable
#define sScene2_NidorinoClose_Map sScene2_NidorinoClose_Map_Portable
#define sScene3_Bg_Pal sScene3_Bg_Pal_Portable
#define sScene3_Bg_Gfx sScene3_Bg_Gfx_Portable
#define sScene3_Bg_Map sScene3_Bg_Map_Portable
#define sScene3_GengarAnim_Gfx sScene3_GengarAnim_Gfx_Portable
#define sScene3_GengarAnim_Map sScene3_GengarAnim_Map_Portable
#define sScene2_Gengar_Gfx sScene2_Gengar_Gfx_Portable
#define sNidorino_Pal sNidorino_Pal_Portable
#define sScene2_Nidorino_Gfx sScene2_Nidorino_Gfx_Portable
#define sScene3_Grass_Pal sScene3_Grass_Pal_Portable
#define sScene3_Grass_Gfx sScene3_Grass_Gfx_Portable
#define sScene3_GengarStatic_Gfx sScene3_GengarStatic_Gfx_Portable
#define sScene3_Nidorino_Gfx sScene3_Nidorino_Gfx_Portable
#define sScene3_Swipe_Pal sScene3_Swipe_Pal_Portable
#define sScene3_RecoilDust_Pal sScene3_RecoilDust_Pal_Portable
#define sScene3_Swipe_Gfx sScene3_Swipe_Gfx_Portable
#define sScene3_RecoilDust_Gfx sScene3_RecoilDust_Gfx_Portable
#else
...
{
#ifdef PORTABLE
    firered_runtime_trace_external("LoadCopyrightGraphics: enter");
    firered_runtime_trace_external("LoadCopyrightGraphics: pre-LZ77UnCompVram gfx");
    firered_runtime_trace_bytes_external("CopyrightGfx", sCopyright_Gfx, (void *)BG_VRAM + charBase);
#endif
    LZ77UnCompVram(sCopyright_Gfx, (void *)BG_VRAM + charBase);
#ifdef PORTABLE
    firered_runtime_trace_external("LoadCopyrightGraphics: post-LZ77UnCompVram gfx");
    firered_runtime_trace_external("LoadCopyrightGraphics: pre-LZ77UnCompVram map");
    firered_runtime_trace_bytes_external("CopyrightMap", sCopyright_Map, (void *)BG_VRAM + screenBase);
#endif
    LZ77UnCompVram(sCopyright_Map, (void *)BG_VRAM + screenBase);
#ifdef PORTABLE
    firered_runtime_trace_external("LoadCopyrightGraphics: post-LZ77UnCompVram map");
    firered_runtime_trace_external("LoadCopyrightGraphics: pre-LoadPalette");
#endif
    LoadPalette(sCopyright_Pal, palOffset, sizeof(sCopyright_Pal));
#ifdef PORTABLE
    firered_runtime_trace_external("LoadCopyrightGraphics: post-LoadPalette");
    firered_runtime_trace_bytes_external("CopyrightVRAMGfxDst", (void *)BG_VRAM + charBase, NULL);
    firered_runtime_trace_bytes_external("CopyrightVRAMMapDst", (void *)BG_VRAM + screenBase, NULL);
    firered_runtime_trace_bytes_external("CopyrightPlttBuffer", &gPlttBufferFaded[palOffset], NULL);
    firered_runtime_trace_external("LoadCopyrightGraphics: exit");
#endif
}
...
{
#ifdef PORTABLE
    firered_runtime_trace_external("SetUpCopyrightScreen: enter");
#endif
    switch (gMain.state)
    {
    case 0:
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-SetVBlankCallback");
#endif
        SetVBlankCallback(NULL);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-SetVBlankCallback");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-SetGpuReg-initial");
#endif
...
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-SetGpuReg-initial");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-DmaFill16-VRAM");
#endif
        DmaFill16(3, 0, VRAM, VRAM_SIZE);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-DmaFill16-VRAM");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-DmaFill32-OAM");
#endif
        DmaFill32(3, 0, OAM, OAM_SIZE);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-DmaFill32-OAM");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-DmaFill16-PLTT");
#endif
        DmaFill16(3, 0, PLTT + sizeof(vu16), PLTT_SIZE - sizeof(vu16));
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-DmaFill16-PLTT");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-ResetPaletteFade");
#endif
        ResetPaletteFade();
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-ResetPaletteFade");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-LoadCopyrightGraphics");
#endif
        LoadCopyrightGraphics(0 * BG_CHAR_SIZE, 7 * BG_SCREEN_SIZE, BG_PLTT_ID(0));
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-LoadCopyrightGraphics");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-ScanlineEffect_Stop");
#endif
        ScanlineEffect_Stop();
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-ScanlineEffect_Stop");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-ResetTasks");
#endif
        ResetTasks();
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-ResetTasks");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-ResetSpriteData");
#endif
        ResetSpriteData();
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-ResetSpriteData");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-FreeAllSpritePalettes");
#endif
        FreeAllSpritePalettes();
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-FreeAllSpritePalettes");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-BeginNormalPaletteFade");
#endif
        BeginNormalPaletteFade(PALETTES_ALL, 0, 16, 0, RGB_WHITEALPHA);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-BeginNormalPaletteFade");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-SetGpuReg-BG0CNT");
#endif
        SetGpuReg(REG_OFFSET_BG0CNT, BGCNT_PRIORITY(0) | BGCNT_CHARBASE(0) | BGCNT_16COLOR | BGCNT_SCREENBASE(7));
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-SetGpuReg-BG0CNT");
        firered_runtime_trace_bytes_external("SetUpCopyrightScreen BG0CNT", (void *)(uintptr_t)REG_ADDR_BG0CNT, NULL);
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-EnableInterrupts");
#endif
        EnableInterrupts(INTR_FLAG_VBLANK);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-EnableInterrupts");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-SetVBlankCallback-Copyright");
#endif
        SetVBlankCallback(VBlankCB_Copyright);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-SetVBlankCallback-Copyright");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-SetGpuReg-DISPCNT");
#endif
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_OBJ_1D_MAP | DISPCNT_BG0_ON);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-SetGpuReg-DISPCNT");
        firered_runtime_trace_bytes_external("SetUpCopyrightScreen DISPCNT", (void *)(uintptr_t)REG_ADDR_DISPCNT, NULL);
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-SetSerialCallback");
#endif
        SetSerialCallback(SerialCB_CopyrightScreen);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-SetSerialCallback");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-GameCubeMultiBoot_Init");
#endif
        GameCubeMultiBoot_Init(&sGcmb);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-GameCubeMultiBoot_Init");
#endif
        // fallthrough
    default:
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-UpdatePaletteFade");
#endif
        UpdatePaletteFade();
        gMain.state++;
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-UpdatePaletteFade");
        firered_runtime_trace_external("SetUpCopyrightScreen: pre-GameCubeMultiBoot_Main");
#endif
        GameCubeMultiBoot_Main(&sGcmb);
#ifdef PORTABLE
        firered_runtime_trace_external("SetUpCopyrightScreen: post-GameCubeMultiBoot_Main");
#endif
        break;
    case 140:
        GameCubeMultiBoot_Main(&sGcmb);
...
#ifdef PORTABLE
    firered_runtime_trace_external("SetUpCopyrightScreen: exit true");
#endif
    return TRUE;
}
...
{
#ifdef PORTABLE
    firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: enter");
    firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: pre-SetUpCopyrightScreen");
#endif
    if (!SetUpCopyrightScreen())
    {
#ifdef PORTABLE
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: post-SetUpCopyrightScreen false");
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: pre-ResetMenuAndMonGlobals");
#endif
        ResetMenuAndMonGlobals();
#ifdef PORTABLE
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: post-ResetMenuAndMonGlobals");
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: pre-Save_ResetSaveCounters");
#endif
        Save_ResetSaveCounters();
#ifdef PORTABLE
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: post-Save_ResetSaveCounters");
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: pre-LoadGameSave");
#endif
        LoadGameSave(SAVE_NORMAL);
#ifdef PORTABLE
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: post-LoadGameSave");
#endif
        ...
        {
#ifdef PORTABLE
            firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: pre-Sav2_ClearSetDefault");
#endif
            Sav2_ClearSetDefault();
#ifdef PORTABLE
            firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: post-Sav2_ClearSetDefault");
#endif
        }
#ifdef PORTABLE
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: pre-SetPokemonCryStereo");
#endif
        SetPokemonCryStereo(gSaveBlock2Ptr->optionsSound);
#ifdef PORTABLE
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: post-SetPokemonCryStereo");
#endif
    }
#ifdef PORTABLE
    else
    {
        firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: post-SetUpCopyrightScreen true");
    }
    firered_runtime_trace_external("CB2_InitCopyrightScreenAfterBootup: exit");
#endif
}
...
#ifdef PORTABLE
    {
        firered_runtime_trace_external("CB2_SetUpIntro: enter");
    }
#endif
    switch (gMain.state)
    {
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_Init", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_GF_OpenWindow", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_GF_Star", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_GF_RevealName", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_GF_RevealLogo", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_Scene1", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_Scene2", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_Scene3_Entrance", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_Scene3_Fight", this);
#endif
    switch (this->state)
    {
    case 0:
...
{
#ifdef PORTABLE
    TraceIntroSequenceState("IntroCB_ExitToTitleScreen", this);
#endif
    switch (this->state)
    {
    case 0:
