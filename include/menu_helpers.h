...
void CreateYesNoMenuWithCallbacks(u8 taskId, const struct WindowTemplate *windowTemplate, u8 fontId, u8 left, u8 top, u16 tileStart, u8 palette, const struct YesNoFuncTable *yesNo);
