...
// Note: This is evaluated at compile time, so we use a simple comparison chain
#define NUM_SUBSTRUCT_BYTES_POKEMON (sizeof(struct PokemonSubstruct0) > sizeof(struct PokemonSubstruct1) ? \
                             (sizeof(struct PokemonSubstruct0) > sizeof(struct PokemonSubstruct2) ? \
                             (sizeof(struct PokemonSubstruct0) > sizeof(struct PokemonSubstruct3) ? sizeof(struct PokemonSubstruct0) : sizeof(struct PokemonSubstruct3)) \
                             : (sizeof(struct PokemonSubstruct2) > sizeof(struct PokemonSubstruct3) ? sizeof(struct PokemonSubstruct2) : sizeof(struct PokemonSubstruct3))) \
                             : (sizeof(struct PokemonSubstruct1) > sizeof(struct PokemonSubstruct2) ? \
                             (sizeof(struct PokemonSubstruct1) > sizeof(struct PokemonSubstruct3) ? sizeof(struct PokemonSubstruct1) : sizeof(struct PokemonSubstruct3)) \
                             : (sizeof(struct PokemonSubstruct2) > sizeof(struct PokemonSubstruct3) ? sizeof(struct PokemonSubstruct2) : sizeof(struct PokemonSubstruct3))))
#define NUM_SUBSTRUCT_BYTES NUM_SUBSTRUCT_BYTES_POKEMON
