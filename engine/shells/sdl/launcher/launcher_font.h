/*
 * Embedded 8x8 bitmap font for the launcher UI.
 * Covers printable ASCII 32..126 (95 glyphs).
...
#define LAUNCHER_FONT_GLYPH_W 8
#define LAUNCHER_FONT_GLYPH_H 8
#define LAUNCHER_FONT_FIRST   32
#define LAUNCHER_FONT_LAST    126

static const uint8_t launcher_font_data[(LAUNCHER_FONT_LAST - LAUNCHER_FONT_FIRST + 1) * 8] = {
    ...
    /* 52 '4' */ 0x0C,0x1C,0x3C,0x6C,0xFE,0x0C,0x0C,0x00,
    ...
    /* 83 'S' */ 0x3C,0x66,0x30,0x18,0x0C,0x66,0x3C,0x00,
